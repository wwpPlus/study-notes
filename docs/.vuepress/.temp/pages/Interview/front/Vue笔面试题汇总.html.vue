<template><h1 id="vue-面试题相关" tabindex="-1"><a class="header-anchor" href="#vue-面试题相关" aria-hidden="true">#</a> Vue 面试题相关</h1>
<h2 id="_1-谈一谈对-mvvm-的理解" tabindex="-1"><a class="header-anchor" href="#_1-谈一谈对-mvvm-的理解" aria-hidden="true">#</a> 1. 谈一谈对 <em>MVVM</em> 的理解？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_2-说一下-vue-的优点" tabindex="-1"><a class="header-anchor" href="#_2-说一下-vue-的优点" aria-hidden="true">#</a> 2. 说一下 <em>Vue</em> 的优点</h2>
<blockquote>
<p>参考答案：</p>
<p><em>Vue</em> 是一个构建数据驱动的 <em>Web</em> 界面的渐进式框架。</p>
<p><em>Vue</em> 的目标是通过尽可能简单的 <em>API</em> 实现响应的数据绑定和组合的视图组件。核心是一个响应的数据绑定系统。</p>
<p>关于 <em>Vue</em> 的优点，主要有响应式编程、组件化开发、虚拟 <em>DOM</em></p>
<p>响应式编程</p>
...
<h2 id="_3-解释一下对-vue-生命周期的理解" tabindex="-1"><a class="header-anchor" href="#_3-解释一下对-vue-生命周期的理解" aria-hidden="true">#</a> 3. 解释一下对 <em>Vue</em> 生命周期的理解</h2>
<ul>
...
<p><em>vue</em> 生命周期有几个阶段</p>
<p>它可以总共分为 <em>8</em> 个阶段：创建前/后, 载入前/后,更新前/后,销毁前/销毁后。</p>
<ul>
<li>
<p><em>beforeCreate</em>：是 <em>new Vue( )</em> 之后触发的第一个钩子，在当前阶段 <em>data、methods、computed</em> 以及 <em>watch</em> 上的数据和方法都不能被访问。</p>
</li>
<li>
<p><em>created</em>：在实例创建完成后发生，当前阶段已经完成了数据观测，也就是可以使用数据，更改数据，在这里更改数据不会触发 <em>updated</em> 函数。可以做一些初始数据的获取，在当前阶段无法与 <em>DOM</em> 进行交互，如果非要想，可以通过 <em>vm.$nextTick</em> 来访问 <em>DOM</em> 。</p>
</li>
<li>
<p><em>beforeMount</em>：发生在挂载之前，在这之前 <em>template</em> 模板已导入渲染函数编译。而当前阶段虚拟 <em>DOM</em> 已经创建完成，即将开始渲染。在此时也可以对数据进行更改，不会触发 <em>updated</em>。</p>
</li>
<li>
<p><em>mounted</em>：在挂载完成后发生，在当前阶段，真实的 <em>DOM</em> 挂载完毕，数据完成双向绑定，可以访问到 <em>DOM</em> 节点，使用 <em>$refs</em> 属性对 <em>DOM</em> 进行操作。</p>
</li>
<li>
<p><em>beforeUpdate</em>：发生在更新之前，也就是响应式数据发生更新，虚拟 <em>DOM</em> 重新渲染之前被触发，你可以在当前阶段进行更改数据，不会造成重渲染。</p>
</li>
<li>
<p><em>updated</em>：发生在更新完成之后，当前阶段组件 <em>DOM</em> 已完成更新。要注意的是避免在此期间更改数据，因为这可能会导致无限循环的更新。</p>
</li>
<li>
<p><em>beforeDestroy</em>：发生在实例销毁之前，在当前阶段实例完全可以被使用，我们可以在这时进行善后收尾工作，比如清除计时器。</p>
</li>
<li>
<p><em>destroyed</em>：发生在实例销毁之后，这个时候只剩下了 <em>DOM</em> 空壳。组件已被拆解，数据绑定被卸除，监听被移出，子实例也统统被销毁。</p>
</li>
</ul>
<p>第一次页面加载会触发哪几个钩子</p>
<p>会触发 <em>4</em> 个钩子，分别是：<em>beforeCreate、created、beforeMount、mounted</em></p>
<p><em>DOM</em> 渲染在哪个周期就已经完成</p>
<p><em>DOM</em> 渲染是在 <em>mounted</em> 阶段完成，此阶段真实的 <em>DOM</em> 挂载完毕，数据完成双向绑定，可以访问到 <em>DOM</em> 节点。</p>
<p>多组件（父子组件）中生命周期的调用顺序说一下</p>
<p>组件的调用顺序都是先父后子，渲染完成的顺序是先子后父。组件的销毁操作是先父后子，销毁完成的顺序是先子后父。</p>
<ul>
<li>
<p>加载渲染过程：父<em>beforeCreate</em>-&gt;父<em>created</em>-&gt;父<em>beforeMount</em>-&gt;子<em>beforeCreate</em>-&gt;子<em>created</em>-&gt;子<em>beforeMount</em>- &gt;子<em>mounted</em>-&gt;父<em>mounted</em></p>
</li>
<li>
<p>子组件更新过程：父<em>beforeUpdate</em>-&gt;子<em>beforeUpdate</em>-&gt;子<em>updated</em>-&gt;父<em>updated</em></p>
</li>
<li>
<p>父组件更新过程：父 <em>beforeUpdate</em> -&gt; 父 <em>updated</em></p>
</li>
<li>
<p>销毁过程：父<em>beforeDestroy</em>-&gt;子<em>beforeDestroy</em>-&gt;子<em>destroyed</em>-&gt;父<em>destroyed</em></p>
</li>
</ul>
</blockquote>
<h2 id="_4-vue-实现双向数据绑定原理是什么" tabindex="-1"><a class="header-anchor" href="#_4-vue-实现双向数据绑定原理是什么" aria-hidden="true">#</a> 4. <em>Vue</em> 实现双向数据绑定原理是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_5-说一下对-vue2-x-响应式原理的理解" tabindex="-1"><a class="header-anchor" href="#_5-说一下对-vue2-x-响应式原理的理解" aria-hidden="true">#</a> 5. 说一下对 <em>Vue2.x</em> 响应式原理的理解</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_6-说一下在-vue2-x-中如何检测数组的变化" tabindex="-1"><a class="header-anchor" href="#_6-说一下在-vue2-x-中如何检测数组的变化" aria-hidden="true">#</a> 6. 说一下在 <em>Vue2.x</em> 中如何检测数组的变化？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>Vue2.x</em> 中实现检测数组变化的方法，是将数组的常用方法进行了重写。<em>Vue</em> 将 <em>data</em> 中的数组进行了原型链重写，指向了自己定义的数组原型方法。这样当调用数组 <em>api</em> 时，可以通知依赖更新。如果数组中包含着引用类型，会对数组中的引用类型再次递归遍历进行监控。这样就实现了监测数组变化。</p>
<p>流程:</p>
<ol>
...
<p>利用索引设置数组项的替代方案</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//使用该方法进行更新视图</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>修改数组的长度的替代方案</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//使用该方法进行更新视图</span>
...
<h2 id="_7-vue3-x-响应式数据" tabindex="-1"><a class="header-anchor" href="#_7-vue3-x-响应式数据" aria-hidden="true">#</a> 7. <em>Vue3.x</em> 响应式数据</h2>
<ul>
...
<p><em>Proxy</em> 只会代理对象的第一层，那么 <em>Vue3</em> 又是怎样处理这个问题的呢？</p>
<p>判断当前 <em>Reflect.get</em> 的返回值是否为 <em>Object</em>，如果是则再通过 <em>reactive</em> 方法做代理， 这样就实现了深度观测。</p>
<p>监测数组的时候可能触发多次 <em>get/set</em>，那么如何防止触发多次呢？</p>
<p>我们可以判断 <em>key</em> 是否为当前被代理对象 <em>target</em> 自身属性，也可以判断旧值与新值是否相等，只有满足以上两个条件之一时，才有可能执行 <em>trigger</em>。</p>
</blockquote>
<h2 id="_8-v-model-双向绑定的原理是什么" tabindex="-1"><a class="header-anchor" href="#_8-v-model-双向绑定的原理是什么" aria-hidden="true">#</a> 8. <em>v-model</em> 双向绑定的原理是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<ol>
<li>
<p>实现一个监听器 <em>Observer</em>，用来劫持并监听所有属性，如果有变动的，就通知订阅者。</p>
</li>
<li>
<p>实现一个订阅者 <em>Watcher</em>，可以收到属性的变化通知并执行相应的函数，从而更新视图。</p>
</li>
<li>
<p>实现一个解析器 <em>Compile</em>，可以扫描和解析每个节点的相关指令，并根据初始化模板数据以及初始化相应的订阅器。</p>
</li>
</ol>
<p>流程图如下：</p>
<img src="https://img-blog.csdnimg.cn/img_convert/717034f25ee385b09e9dee53b2988cae.png" alt="img"  />
</blockquote>
<h2 id="_9-vue2-x-和-vuex3-x-渲染器的-diff-算法分别说一下" tabindex="-1"><a class="header-anchor" href="#_9-vue2-x-和-vuex3-x-渲染器的-diff-算法分别说一下" aria-hidden="true">#</a> 9. <em>vue2.x</em> 和 <em>vuex3.x</em> 渲染器的 <em>diff</em> 算法分别说一下？</h2>
<blockquote>
<p>直播讲解</p>
</blockquote>
<blockquote>
...
<p>正常 <em>Diff</em> 两个树的时间复杂度是 <em>O(n^3)</em>，但实际情况下我们很少会进行跨层级的移动 <em>DOM</em>，所以 <em>Vue</em> 将 <em>Diff</em> 进行了优化，从<em>O(n^3) -&gt; O(n)</em>，只有当新旧 <em>children</em> 都为多个子节点时才需要用核心的 <em>Diff</em> 算法进行同层级比较。</p>
...
<h2 id="_10-vue-组件的参数传递" tabindex="-1"><a class="header-anchor" href="#_10-vue-组件的参数传递" aria-hidden="true">#</a> 10. <em>vue</em> 组件的参数传递</h2>
<ul>
...
<blockquote>
<p>参考答案：</p>
<p>解释一下父组件与子组件传值实现过程</p>
<ul>
<li>
<p>父组件传给子组件：子组件通过 <em>props</em> 方法接受数据</p>
</li>
<li>
<p>子组件传给父组件：使用自定义事件，自组件通过 <em>$emit</em> 方法触发父组件的方法来传递参数</p>
</li>
</ul>
<p>非父子组件的数据传递，兄弟组件传值是如何实现的</p>
...
<h2 id="_11-vue-的路由实现" tabindex="-1"><a class="header-anchor" href="#_11-vue-的路由实现" aria-hidden="true">#</a> 11. <em>Vue</em> 的路由实现</h2>
<ul>
...
<blockquote>
<p>参考答案：</p>
<p>解释 <em>hash</em> 模式和 <em>history</em> 模式的实现原理</p>
...
<ul>
<li>
<p>首先是在 <em>URL</em> 的展示上，<em>hash</em> 模式有“#”，<em>history</em> 模式没有</p>
</li>
<li>
<p>刷新页面时，<em>hash</em> 模式可以正常加载到 <em>hash</em> 值对应的页面，而 <em>history</em> 没有处理的话，会返回 <em>404</em>，一般需要后端将所有页面都配置重定向到首页路由</p>
</li>
<li>
<p>在兼容性上，<em>hash</em> 可以支持低版本浏览器和 <em>IE</em></p>
</li>
</ul>
<p>说一下 <em>$router</em> 与 <em>$route</em> 的区别</p>
...
<p><em>vueRouter</em> 有哪几种导航守卫？</p>
<ul>
<li>
<p>全局前置/钩子：<em>beforeEach、beforeR-esolve、afterEach</em></p>
</li>
<li>
<p>路由独享的守卫：<em>beforeEnter</em></p>
</li>
<li>
<p>组件内的守卫：<em>beforeRouteEnter、beforeRouteUpdate、beforeRouteLeave</em></p>
</li>
</ul>
<p>解释一下 <em>vueRouter</em> 的完整的导航解析流程是什么</p>
<p>一次完整的导航解析流程如下：</p>
<ol>
<li>导航被触发。</li>
<li>在失活的组件里调用离开守卫。</li>
<li>调用全局的 <em>beforeEach</em> 守卫。</li>
<li>在重用的组件里调用 <em>beforeRouteUpdate</em> 守卫（<em>2.2+</em>）。</li>
<li>在路由配置里调用 <em>beforeEnter</em>。</li>
<li>解析异步路由组件。</li>
<li>在被激活的组件里调用 <em>beforeRouteEnter</em>。</li>
<li>调用全局的 <em>beforeResolve</em> 守卫（<em>2.5+</em>）。</li>
<li>导航被确认。</li>
...
<h2 id="_12-vuex-是什么-怎么使用它-什么场景下我们会使用到-vuex" tabindex="-1"><a class="header-anchor" href="#_12-vuex-是什么-怎么使用它-什么场景下我们会使用到-vuex" aria-hidden="true">#</a> 12. <em>vuex</em> 是什么？怎么使用它？什么场景下我们会使用到 <em>vuex</em></h2>
<blockquote>
<p>参考答案：</p>
<p><em>vuex</em> 是什么</p>
...
<h2 id="_13-说一下-v-for-与-v-show-的区别" tabindex="-1"><a class="header-anchor" href="#_13-说一下-v-for-与-v-show-的区别" aria-hidden="true">#</a> 13. 说一下 <em>v-for</em> 与 <em>v-show</em> 的区别</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>共同点：都是动态显示 <em>DOM</em> 元素</p>
</li>
<li>
<p>区别点:</p>
<ul>
...
<h2 id="_14-如何让-css-值在当前的组件中起作用" tabindex="-1"><a class="header-anchor" href="#_14-如何让-css-值在当前的组件中起作用" aria-hidden="true">#</a> 14. 如何让 <em>CSS</em> 值在当前的组件中起作用</h2>
<blockquote>
<p>参考答案：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>转译后：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>template<span class="token operator">></span>
...
<h2 id="_15-keep-alive-相关" tabindex="-1"><a class="header-anchor" href="#_15-keep-alive-相关" aria-hidden="true">#</a> 15. <em>keep-alive</em> 相关</h2>
<ul>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// keep-alive 内部的声明周期函数</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>key 数组记录目前缓存的组件 key 值，如果组件没有指定 key 值，则会为其自动生成一个唯一的 key 值</p>
...
<h2 id="_16-vue-中如何进行组件的使用-vue-如何实现全局组件的注册" tabindex="-1"><a class="header-anchor" href="#_16-vue-中如何进行组件的使用-vue-如何实现全局组件的注册" aria-hidden="true">#</a> 16. <em>Vue</em> 中如何进行组件的使用？<em>Vue</em> 如何实现全局组件的注册？</h2>
<blockquote>
<p>参考答案：</p>
<p>要使用组件，首先需要使用 <em>import</em> 来引入组件，然后在 <em>components</em> 属性中注册组件，之后就可以在模板中使用组件了。</p>
<p>可以使用 <em>Vue.component</em> 方法来实现全局组件的注册。</p>
</blockquote>
<h2 id="_17-vue-cli-工程相关" tabindex="-1"><a class="header-anchor" href="#_17-vue-cli-工程相关" aria-hidden="true">#</a> 17. <em>vue-cli</em> 工程相关</h2>
<ul>
...
<blockquote>
<p>参考答案：</p>
<p>构建 <em>vue-cli</em> 工程都用到了哪些技术？他们的作用分别是什么？</p>
<ol>
...
<li>axios（或者 fetch、ajax）：用于发起 GET 、或 POST 等 http 请求，基于 Promise 设计。</li>
<li>vux 等：一个专为 vue 设计的移动端 UI 组件库。</li>
<li>webpack：模块加载和 vue-cli 工程打包器。</li>
<li>eslint：代码规范工具</li>
</ol>
<p><em>vue-cli</em> 工程常用的 <em>npm</em> 命令有哪些？</p>
<p>下载 node_modules 资源包的命令：npm install</p>
<p>启动 vue-cli 开发环境的 npm 命令：npm run dev</p>
<p>vue-cli 生成 生产环境部署资源 的 npm 命令：npm run build</p>
<p>用于查看 vue-cli 生产环境部署资源文件大小的 npm 命令：npm run build --report</p>
</blockquote>
<h2 id="_18-nexttick-的作用是什么-他的实现原理是什么" tabindex="-1"><a class="header-anchor" href="#_18-nexttick-的作用是什么-他的实现原理是什么" aria-hidden="true">#</a> 18. <em>nextTick</em> 的作用是什么？他的实现原理是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_19-说一下-vue-ssr-的实现原理" tabindex="-1"><a class="header-anchor" href="#_19-说一下-vue-ssr-的实现原理" aria-hidden="true">#</a> 19. 说一下 <em>Vue SSR</em> 的实现原理</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<li>客户端混合，客户端收到从服务端传来的 <em>DOM</em> 与自己的生成的 <em>DOM</em> 进行对比，把不相同的 <em>DOM</em> 激活，使其可以能够响应后续变化，这个过程称为客户端激活（也就是转换为单页应用）。为确保混合成功，客户 端与服务器端需要共享同一套数据。在服务端，可以在渲染之前获取数据，填充到 <em>store</em> 里，这样，在客户端挂载到 <em>DOM</em> 之前，可以直接从 <em>store</em> 里取数据。首屏的动态数据通过 *window.**INITIAL*STATE**_ 发送到客户端</li>
<li><em>VueSSR</em> 的原理，主要就是通过 <em>vue-server-renderer</em> 把 <em>Vue</em> 的组件输出成一个完整 <em>HTML</em>，输出到客户端，到达客户端后重新展开为一个单页应用。</li>
</ul>
</blockquote>
<h2 id="_20-vue-组件的-data-为什么必须是函数" tabindex="-1"><a class="header-anchor" href="#_20-vue-组件的-data-为什么必须是函数" aria-hidden="true">#</a> 20. <em>Vue</em> 组件的 <em>data</em> 为什么必须是函数</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_21-说一下-vue-的-computed-的实现原理" tabindex="-1"><a class="header-anchor" href="#_21-说一下-vue-的-computed-的实现原理" aria-hidden="true">#</a> 21. 说一下 <em>Vue</em> 的 <em>computed</em> 的实现原理</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_22-说一下-vue-complier-的实现原理是什么样的" tabindex="-1"><a class="header-anchor" href="#_22-说一下-vue-complier-的实现原理是什么样的" aria-hidden="true">#</a> 22. 说一下 <em>Vue complier</em> 的实现原理是什么样的？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_23-vue-如何快速定位那个组件出现性能问题的" tabindex="-1"><a class="header-anchor" href="#_23-vue-如何快速定位那个组件出现性能问题的" aria-hidden="true">#</a> 23. <em>vue</em> 如何快速定位那个组件出现性能问题的</h2>
<blockquote>
<p>参考答案：</p>
<p>⽤ <em>timeline</em> ⼯具。 通过 <em>timeline</em> 来查看每个函数的调⽤时常，定位出哪个函数的问题，从⽽能判断哪个组件出了问题。</p>
</blockquote>
<h2 id="_24-proxy-相比-defineproperty-的优势在哪里" tabindex="-1"><a class="header-anchor" href="#_24-proxy-相比-defineproperty-的优势在哪里" aria-hidden="true">#</a> 24. <em>Proxy</em> 相比 <em>defineProperty</em> 的优势在哪里</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_25-vue-与-angular-以及-react-的区别是什么" tabindex="-1"><a class="header-anchor" href="#_25-vue-与-angular-以及-react-的区别是什么" aria-hidden="true">#</a> 25. <em>Vue</em> 与 <em>Angular</em> 以及 <em>React</em> 的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p>这种题目是开放性题目，一般是面试过程中面试官口头来提问，不太可能出现在笔试试卷里面。</p>
<p>关于 <em>Vue</em> 和其他框架的不同，官方专门写了一篇文档，从性能、体积、灵活性等多个方面来进行了说明。</p>
<p>详细可以参阅：<em>https://cn.vuejs.org/v2/guide/comparison.html</em></p>
<p>建议面试前通读一遍该篇文档，然后进行适当的总结。</p>
</blockquote>
<h2 id="_26-说一下-watch-与-computed-的区别是什么-以及他们的使用场景分别是什么" tabindex="-1"><a class="header-anchor" href="#_26-说一下-watch-与-computed-的区别是什么-以及他们的使用场景分别是什么" aria-hidden="true">#</a> 26. 说一下 <em>watch</em> 与 <em>computed</em> 的区别是什么？以及他们的使用场景分别是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p>区别：</p>
<ol>
...
<p>computed 缓存原理：</p>
<p>conputed 本质是一个惰性的观察者；当计算数据存在于 data 或者 props 里时会被警告；</p>
...
<h2 id="_27-scoped-是如何实现样式穿透的" tabindex="-1"><a class="header-anchor" href="#_27-scoped-是如何实现样式穿透的" aria-hidden="true">#</a> 27. <em>scoped</em> 是如何实现样式穿透的？</h2>
<blockquote>
<p>参考答案：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>上述代码将会编译成：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">.</span>a<span class="token punctuation">[</span>data<span class="token operator">-</span>v<span class="token operator">-</span>f3f3eg9<span class="token punctuation">]</span> <span class="token punctuation">.</span>b <span class="token punctuation">{</span> <span class="token comment">/* ... */</span> <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>后面的类名没有 <em>data</em> 属性，所以能选到子组件里面的类名。</p>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>style<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>此时，我们只需要将修改第三方样式的 <em>css</em> 写在第一个 <em>style</em> 中即可。</p>
<p>方法三</p>
...
<h2 id="_28-说一下-ref-的作用是什么" tabindex="-1"><a class="header-anchor" href="#_28-说一下-ref-的作用是什么" aria-hidden="true">#</a> 28. 说一下 <em>ref</em> 的作用是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_29-说一下你知道的-vue-修饰符都有哪些" tabindex="-1"><a class="header-anchor" href="#_29-说一下你知道的-vue-修饰符都有哪些" aria-hidden="true">#</a> 29. 说一下你知道的 <em>vue</em> 修饰符都有哪些？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_30-如何实现-vue-项目中的性能优化" tabindex="-1"><a class="header-anchor" href="#_30-如何实现-vue-项目中的性能优化" aria-hidden="true">#</a> 30. 如何实现 <em>vue</em> 项目中的性能优化？</h2>
<blockquote>
<p>直播课讲解</p>
</blockquote>
<blockquote>
...
<h2 id="_31-vue-extend-和-vue-component-的区别是什么" tabindex="-1"><a class="header-anchor" href="#_31-vue-extend-和-vue-component-的区别是什么" aria-hidden="true">#</a> 31. <em>Vue.extend</em> 和 <em>Vue.component</em> 的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>Vue.extend</em> 用于创建一个基于 <em>Vue</em> 构造函数的“子类”，其参数应为一个包含组件选项的对象。</p>
<p><em>Vue.component</em> 用来注册全局组件。</p>
</blockquote>
<h2 id="_32-vue-中的-spa-应用如何优化首屏加载速度" tabindex="-1"><a class="header-anchor" href="#_32-vue-中的-spa-应用如何优化首屏加载速度" aria-hidden="true">#</a> 32. <em>vue</em> 中的 <em>spa</em> 应用如何优化首屏加载速度?</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_33-移动端如何实现一个比较友好的-header-组件" tabindex="-1"><a class="header-anchor" href="#_33-移动端如何实现一个比较友好的-header-组件" aria-hidden="true">#</a> 33. 移动端如何实现一个比较友好的 <em>header</em> 组件</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_34-既然-vue-通过数据劫持可以精准探测数据变化-为什么还需要虚拟-dom-进行-diff-监测差异" tabindex="-1"><a class="header-anchor" href="#_34-既然-vue-通过数据劫持可以精准探测数据变化-为什么还需要虚拟-dom-进行-diff-监测差异" aria-hidden="true">#</a> 34. 既然 <em>Vue</em> 通过数据劫持可以精准探测数据变化，为什么还需要虚拟 <em>DOM</em> 进行 <em>diff</em> 监测差异 ？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_35-vue-为什么没有类似于-react-中-shouldcomponentupdate-的生命周期" tabindex="-1"><a class="header-anchor" href="#_35-vue-为什么没有类似于-react-中-shouldcomponentupdate-的生命周期" aria-hidden="true">#</a> 35. <em>Vue</em> 为什么没有类似于 <em>React</em> 中 <em>shouldComponentUpdate</em> 的生命周期？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_36-vue-中的-key-的作用是什么" tabindex="-1"><a class="header-anchor" href="#_36-vue-中的-key-的作用是什么" aria-hidden="true">#</a> 36. <em>Vue</em> 中的 <em>Key</em> 的作用是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>key</em> 的作用主要是为了高效的更新虚拟 <em>DOM</em>。另外 <em>vue</em> 中在使用相同标签名元素的过渡切换时，也会使用到 <em>key</em> 属性，其目的也是为了让 <em>vue</em> 可以区分它们，否则 <em>vue</em> 只会替换其内部属性而不会触发过渡效果。</p>
</blockquote>
<blockquote>
<p>解析：</p>
...
<ul>
<li>
<p>两个相同的组件产生类似的 <em>DOM</em> 结构，不同的组件产生不同的 <em>DOM</em> 结构。</p>
</li>
<li>
<p>同一层级的一组节点，他们可以通过唯一的 <em>id</em> 进行区分。</p>
</li>
</ul>
...
<h2 id="_37-你的接口请求一般放在哪个生命周期中-为什么要这样做" tabindex="-1"><a class="header-anchor" href="#_37-你的接口请求一般放在哪个生命周期中-为什么要这样做" aria-hidden="true">#</a> 37. 你的接口请求一般放在哪个生命周期中？为什么要这样做？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_38-说一下你对-vue-事件绑定原理的理解" tabindex="-1"><a class="header-anchor" href="#_38-说一下你对-vue-事件绑定原理的理解" aria-hidden="true">#</a> 38. 说一下你对 <em>vue</em> 事件绑定原理的理解？</h2>
<blockquote>
<p>参考答案：</p>
...
<p>组件事件绑定原理</p>
<p>在组件实例初始化会调用 initMixin 方法中的 Vue.prototype.*init，在 init 函数中，会通过 initInternalComponent 方法初始化组件信息，将自定义的组件事件放到*parentListeners 上，下来就会调用 initEvents 来初始化组件事件，在 initEvents 中会实例上添加一个 *event 对象，用于保存自定义事件，然后获取到 父组件给 子组件绑定的自定义事件，也就是刚才在初始化组件信息的时候将自定义的组件事件放在了*parentListeners 上，这时候 vm.$options._parentListeners 就是自定义的事件。</p>
...
<h2 id="_39-说一下-vue-模版编译的原理是什么" tabindex="-1"><a class="header-anchor" href="#_39-说一下-vue-模版编译的原理是什么" aria-hidden="true">#</a> 39. 说一下 <em>vue</em> 模版编译的原理是什么</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_40-delete-和-vue-delete-删除数组的区别是什么" tabindex="-1"><a class="header-anchor" href="#_40-delete-和-vue-delete-删除数组的区别是什么" aria-hidden="true">#</a> 40. <em>delete</em> 和 <em>Vue.delete</em> 删除数组的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>delete</em> 只是被删除的元素变成了 <em>empty/undefined</em> 其他的元素的键值还是不变。
<em>Vue.delete</em> 是直接将元素从数组中完全删除，改变了数组其他元素的键值。</p>
</blockquote>
<h2 id="_41-v-on-可以实现监听多个方法么" tabindex="-1"><a class="header-anchor" href="#_41-v-on-可以实现监听多个方法么" aria-hidden="true">#</a> 41. <em>v-on</em> 可以实现监听多个方法么？</h2>
<blockquote>
<p>参考答案：</p>
<p>可以监听多个方法。关于监听多个方法提供了几种不同的写法：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>写法一：
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>示例代码如下：</p>
...
<h2 id="_42-vue-的数据为什么频繁变化但只会更新一次" tabindex="-1"><a class="header-anchor" href="#_42-vue-的数据为什么频繁变化但只会更新一次" aria-hidden="true">#</a> 42. <em>vue</em> 的数据为什么频繁变化但只会更新一次？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_43-说一下-vue-中-computed-和-methods-的区别是什么" tabindex="-1"><a class="header-anchor" href="#_43-说一下-vue-中-computed-和-methods-的区别是什么" aria-hidden="true">#</a> 43. 说一下 <em>vue</em> 中 <em>computed</em> 和 <em>methods</em> 的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_44-在-vue-中要获取当前时间你会放到-computed-还是-methods-里-抖音直播" tabindex="-1"><a class="header-anchor" href="#_44-在-vue-中要获取当前时间你会放到-computed-还是-methods-里-抖音直播" aria-hidden="true">#</a> 44. 在 <em>Vue</em> 中要获取当前时间你会放到 <em>computed</em> 还是 <em>methods</em> 里？(抖音直播)</h2>
<blockquote>
<p>参考答案：</p>
<p>放在 <em>computed</em> 里面。因为 <em>computed</em> 只有在它的相关依赖发生改变时才会重新求值。相比而言，方法只要发生重新渲染，<em>methods</em> 调用总会执行所有函数。</p>
</blockquote>
<h2 id="_45-在给-vue-中的元素设置-key-值时可以使用-math-的-random-方法么" tabindex="-1"><a class="header-anchor" href="#_45-在给-vue-中的元素设置-key-值时可以使用-math-的-random-方法么" aria-hidden="true">#</a> 45. 在给 <em>vue</em> 中的元素设置 <em>key</em> 值时可以使用 <em>Math</em> 的 <em>random</em> 方法么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_46-插槽与作用域插槽的区别是什么" tabindex="-1"><a class="header-anchor" href="#_46-插槽与作用域插槽的区别是什么" aria-hidden="true">#</a> 46. 插槽与作用域插槽的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p>插槽的作用是子组件提供了可替换模板，父组件可以更换模板的内容。</p>
<p>作用域插槽给了子组件将数据返给父组件的能力，子组件一样可以复用，同时父组件也可以重新组织内容和样式。</p>
</blockquote>
<h2 id="_47-vue-中相同逻辑如何进行抽离" tabindex="-1"><a class="header-anchor" href="#_47-vue-中相同逻辑如何进行抽离" aria-hidden="true">#</a> 47. <em>vue</em> 中相同逻辑如何进行抽离？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_48-如何监听-pushstate-和-replacestate-的变化呢" tabindex="-1"><a class="header-anchor" href="#_48-如何监听-pushstate-和-replacestate-的变化呢" aria-hidden="true">#</a> 48. 如何监听 <em>pushstate</em> 和 <em>replacestate</em> 的变化呢？</h2>
<blockquote>
<p>参考答案：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>这样就创建了 <em>2</em> 个全新的事件，事件名为 <em>pushState</em> 和 <em>replaceState</em>，我们就可以在全局监听：</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>这样就可以监听到 <em>pushState</em> 和 <em>replaceState</em> 行为。</p>
</blockquote>
<h2 id="_49-说一下-vue3-0-是如何变得更快的" tabindex="-1"><a class="header-anchor" href="#_49-说一下-vue3-0-是如何变得更快的" aria-hidden="true">#</a> 49. 说一下 <em>vue3.0</em> 是如何变得更快的？</h2>
<blockquote>
<p>参考答案：</p>
<p>优化 <em>Diff</em> 算法</p>
...
<h2 id="_50-说一说自定义指令有哪些生命周期" tabindex="-1"><a class="header-anchor" href="#_50-说一说自定义指令有哪些生命周期" aria-hidden="true">#</a> 50. 说一说自定义指令有哪些生命周期？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_51-说一说相比-vue3-x-对比-vue2-x-变化" tabindex="-1"><a class="header-anchor" href="#_51-说一说相比-vue3-x-对比-vue2-x-变化" aria-hidden="true">#</a> 51. 说一说相比 <em>vue3.x</em> 对比 <em>vue2.x</em> 变化</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_52-vue-为什么采用异步渲染" tabindex="-1"><a class="header-anchor" href="#_52-vue-为什么采用异步渲染" aria-hidden="true">#</a> 52. <em>vue</em> 为什么采用异步渲染</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_53-组件中写-name-选项有哪些好处" tabindex="-1"><a class="header-anchor" href="#_53-组件中写-name-选项有哪些好处" aria-hidden="true">#</a> 53. 组件中写 <em>name</em> 选项有哪些好处</h2>
<blockquote>
<p>参考答案：</p>
<ol>
