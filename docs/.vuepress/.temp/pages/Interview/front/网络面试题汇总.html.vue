<template><h1 id="网络面试题汇总" tabindex="-1"><a class="header-anchor" href="#网络面试题汇总" aria-hidden="true">#</a> 网络面试题汇总</h1>
<p><img src="imgs/network.jpg" alt="network"></p>
<h2 id="_1-简述-tcp-连接的过程-淘系" tabindex="-1"><a class="header-anchor" href="#_1-简述-tcp-连接的过程-淘系" aria-hidden="true">#</a> 1. 简述 TCP 连接的过程（淘系）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_2-介绍下-https-中间人攻击" tabindex="-1"><a class="header-anchor" href="#_2-介绍下-https-中间人攻击" aria-hidden="true">#</a> 2. 介绍下 HTTPS 中间人攻击</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_3-介绍下-http1-0、http1-1、http2-0-协议的区别" tabindex="-1"><a class="header-anchor" href="#_3-介绍下-http1-0、http1-1、http2-0-协议的区别" aria-hidden="true">#</a> 3. 介绍下 <code>http1.0</code>、<code>http1.1</code>、<code>http2.0</code> 协议的区别？</h2>
<blockquote>
<p>参考答案：</p>
<p>首先说 http1.0</p>
...
<h2 id="_4-为什么-http1-1-不能实现多路复用-腾讯" tabindex="-1"><a class="header-anchor" href="#_4-为什么-http1-1-不能实现多路复用-腾讯" aria-hidden="true">#</a> 4. 为什么 HTTP1.1 不能实现多路复用（腾讯）</h2>
<blockquote>
<p>参考答案：</p>
<p>HTTP/1.1 不是二进制传输，而是通过文本进行传输。由于没有流的概念，在使用并行传输（多路复用）传递数据时，接收端在接收到响应后，并不能区分多个响应分别对应的请求，所以无法将多个响应的结果重新进行组装，也就实现不了多路复用。</p>
</blockquote>
<h2 id="_5-简单讲解一下-http2-的多路复用-网易" tabindex="-1"><a class="header-anchor" href="#_5-简单讲解一下-http2-的多路复用-网易" aria-hidden="true">#</a> 5. 简单讲解一下 http2 的多路复用（网易）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_6-谈谈你对-tcp-三次握手和四次挥手的理解" tabindex="-1"><a class="header-anchor" href="#_6-谈谈你对-tcp-三次握手和四次挥手的理解" aria-hidden="true">#</a> 6. 谈谈你对 TCP 三次握手和四次挥手的理解</h2>
<blockquote>
<p>TCP 协议通过三次握手建立可靠的点对点连接，具体过程是：</p>
<p>首先服务器进入监听状态，然后即可处理连接</p>
<p>第一次握手：建立连接时，客户端发送 syn 包到服务器，并进入 SYN_SENT 状态，等待服务器确认。在发送的包中还会包含一个初始序列号 seq。此次握手的含义是客户端希望与服务器建立连接。</p>
...
<h2 id="_7-介绍-https-握手过程" tabindex="-1"><a class="header-anchor" href="#_7-介绍-https-握手过程" aria-hidden="true">#</a> 7. 介绍 HTTPS 握手过程</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_8-https-握手过程中-客户端如何验证证书的合法性" tabindex="-1"><a class="header-anchor" href="#_8-https-握手过程中-客户端如何验证证书的合法性" aria-hidden="true">#</a> 8. HTTPS 握手过程中，客户端如何验证证书的合法性</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_9-http-状态码-301-和-302-的应用场景分别是什么" tabindex="-1"><a class="header-anchor" href="#_9-http-状态码-301-和-302-的应用场景分别是什么" aria-hidden="true">#</a> 9. Http 状态码 301 和 302 的应用场景分别是什么</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_10-cookie-和-token-都存放在-header-中-为什么不会劫持-token" tabindex="-1"><a class="header-anchor" href="#_10-cookie-和-token-都存放在-header-中-为什么不会劫持-token" aria-hidden="true">#</a> 10. cookie 和 token 都存放在 header 中，为什么不会劫持 token？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_11-介绍下如何实现-token-加密" tabindex="-1"><a class="header-anchor" href="#_11-介绍下如何实现-token-加密" aria-hidden="true">#</a> 11. 介绍下如何实现 token 加密</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_12-说下单点登录-新东方" tabindex="-1"><a class="header-anchor" href="#_12-说下单点登录-新东方" aria-hidden="true">#</a> 12. 说下单点登录（新东方）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_13-http1-1-是如何复用-tcp-连接的-网易" tabindex="-1"><a class="header-anchor" href="#_13-http1-1-是如何复用-tcp-连接的-网易" aria-hidden="true">#</a> 13. http1.1 是如何复用 tcp 连接的？（网易）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_14-文件上传如何做断点续传-网易" tabindex="-1"><a class="header-anchor" href="#_14-文件上传如何做断点续传-网易" aria-hidden="true">#</a> 14. 文件上传如何做断点续传（网易）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_15-介绍-ssl-和-tls-寺库" tabindex="-1"><a class="header-anchor" href="#_15-介绍-ssl-和-tls-寺库" aria-hidden="true">#</a> 15. 介绍 SSL 和 TLS（寺库）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_16-说说网络的五层模型-寺库" tabindex="-1"><a class="header-anchor" href="#_16-说说网络的五层模型-寺库" aria-hidden="true">#</a> 16. 说说网络的五层模型（寺库）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_17-get-和-post-的区别-流利说" tabindex="-1"><a class="header-anchor" href="#_17-get-和-post-的区别-流利说" aria-hidden="true">#</a> 17. GET 和 POST 的区别（流利说）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_18-http-劫持是什么" tabindex="-1"><a class="header-anchor" href="#_18-http-劫持是什么" aria-hidden="true">#</a> 18. http 劫持是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p>是指攻击者在客户端和服务器之间同时建立了连接通道，通过某种方式，让客户端请求发送到自己的服务器，然后自己就拥有了控制响应内容的能力，从而给客户端展示错误的信息。</p>
</blockquote>
<h2 id="_19-http-劫持、dns-劫持与-xss" tabindex="-1"><a class="header-anchor" href="#_19-http-劫持、dns-劫持与-xss" aria-hidden="true">#</a> 19. HTTP 劫持、DNS 劫持与 XSS</h2>
<blockquote>
<p>参考答案：</p>
...
<p>要防范 XSS 攻击，需要在服务器端过滤脚本代码，将一些危险的元素和属性去掉或对元素进行 HTML 实体编码。</p>
</blockquote>
<h2 id="_20-介绍-xss-csrf-攻击" tabindex="-1"><a class="header-anchor" href="#_20-介绍-xss-csrf-攻击" aria-hidden="true">#</a> 20. 介绍 xss csrf 攻击</h2>
<blockquote>
<p>参考答案：</p>
<p>XSS：</p>
<p>XSS 是指跨站脚本攻击。攻击者利用站点的漏洞，在表单提交时，在表单内容中加入一些恶意脚本，当其他正常用户浏览页面，而页面中刚好出现攻击者的恶意脚本时，脚本被执行，从而使得页面遭到破坏，或者用户信息被窃取。</p>
...
<li>cookie 中使用 sameSite 字段</li>
<li>服务器检查 referer 字段</li>
</ol>
</blockquote>
<h2 id="_21-https-验证身份也就是-tsl-ssl-身份验证的过程" tabindex="-1"><a class="header-anchor" href="#_21-https-验证身份也就是-tsl-ssl-身份验证的过程" aria-hidden="true">#</a> 21. https 验证身份也就是 TSL/SSL 身份验证的过程</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>客户端请求服务器，并告诉服务器自身支持的加密算法以及密钥长度等信息</li>
...
<h2 id="_22-为什么需要-ca-机构对证书签名" tabindex="-1"><a class="header-anchor" href="#_22-为什么需要-ca-机构对证书签名" aria-hidden="true">#</a> 22. 为什么需要 CA 机构对证书签名</h2>
<blockquote>
<p>参考答案：</p>
<p>主要是为了解决证书的可信问题。如果没有权威机构对证书进行签名，客户端就无法知晓证书是否是伪造的，从而增加了中间人攻击的风险，https 就变得毫无意义。</p>
</blockquote>
<h2 id="_23-身份验证过程中会涉及到密钥-对称加密-非对称加密-摘要的概念-请解释一下" tabindex="-1"><a class="header-anchor" href="#_23-身份验证过程中会涉及到密钥-对称加密-非对称加密-摘要的概念-请解释一下" aria-hidden="true">#</a> 23. 身份验证过程中会涉及到密钥，对称加密，非对称加密，摘要的概念，请解释一下</h2>
<blockquote>
<p>参考答案：</p>
<p>密钥</p>
...
<h2 id="_24-websocket-协议是什么-能简述一下吗" tabindex="-1"><a class="header-anchor" href="#_24-websocket-协议是什么-能简述一下吗" aria-hidden="true">#</a> 24. webSocket 协议是什么，能简述一下吗？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_25-websocket-与传统的-http-有什么优势" tabindex="-1"><a class="header-anchor" href="#_25-websocket-与传统的-http-有什么优势" aria-hidden="true">#</a> 25. webSocket 与传统的 http 有什么优势</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_26-如何劫持-https-的请求-提供思路" tabindex="-1"><a class="header-anchor" href="#_26-如何劫持-https-的请求-提供思路" aria-hidden="true">#</a> 26. 如何劫持 https 的请求，提供思路</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_27-怎样解决跨域问题" tabindex="-1"><a class="header-anchor" href="#_27-怎样解决跨域问题" aria-hidden="true">#</a> 27. 怎样解决跨域问题？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_28-前端如何实现即时通讯" tabindex="-1"><a class="header-anchor" href="#_28-前端如何实现即时通讯" aria-hidden="true">#</a> 28. 前端如何实现即时通讯？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_29-http-常用状态码-301-302-304-403" tabindex="-1"><a class="header-anchor" href="#_29-http-常用状态码-301-302-304-403" aria-hidden="true">#</a> 29. HTTP 常用状态码 301 302 304 403</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_30-在浏览器地址栏输入地址-并按下回车键后-发生了哪些事情" tabindex="-1"><a class="header-anchor" href="#_30-在浏览器地址栏输入地址-并按下回车键后-发生了哪些事情" aria-hidden="true">#</a> 30. 在浏览器地址栏输入地址，并按下回车键后，发生了哪些事情？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>浏览器自动补全协议、端口</li>
<li>浏览器自动完成 url 编码</li>
...
<li>若使用了 HTTPS 协议，则还会进行 SSL 握手，建立加密信道。使用 SSL 握手时，会确定是否使用 HTTP2</li>
...
<h2 id="_31-https-握手" tabindex="-1"><a class="header-anchor" href="#_31-https-握手" aria-hidden="true">#</a> 31. HTTPS 握手</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>客户端请求服务器，并告诉服务器自身支持的加密算法以及密钥长度等信息</li>
...
<h2 id="_32-网页验证码是干嘛的-是为了解决什么安全问题" tabindex="-1"><a class="header-anchor" href="#_32-网页验证码是干嘛的-是为了解决什么安全问题" aria-hidden="true">#</a> 32. 网页验证码是干嘛的，是为了解决什么安全问题？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_33-http1-0、http2-0、http3-0-之间的区别" tabindex="-1"><a class="header-anchor" href="#_33-http1-0、http2-0、http3-0-之间的区别" aria-hidden="true">#</a> 33. http1.0、http2.0、http3.0 之间的区别</h2>
<blockquote>
<p>参考答案：</p>
<p>http1.0</p>
...
<h2 id="_34-cookie-sessionstorage-localstorage-的区别" tabindex="-1"><a class="header-anchor" href="#_34-cookie-sessionstorage-localstorage-的区别" aria-hidden="true">#</a> 34. cookie/sessionStorage/localStorage 的区别</h2>
<blockquote>
<p>参考答案：</p>
...
<p>HTML5 新增了 sessionStorage 和 localStorage，前者用于保存会话级别的数据，后者用于更持久的保存数据。浏览器针对它们没有任何默认行为，这样一来，就把保存数据、读取数据的工作交给了前端开发者，这就让恶意攻击者难以针对登录状态进行攻击。
cookie 的大小是有限制的，一般浏览器会限制同一个域下的 cookie 总量为 4M，而 sessionStorage 和 localStorage 则没有限制
cookie 会与 domain、path 关联，而 sessionStorage 和 localStorage 只与 domain 关联</p>
</blockquote>
<h2 id="_35-post-请求什么时候用-form-data-什么时候用-request-payload" tabindex="-1"><a class="header-anchor" href="#_35-post-请求什么时候用-form-data-什么时候用-request-payload" aria-hidden="true">#</a> 35. post 请求什么时候用 form data 什么时候用 request payload</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_36-http-常见请求方法有哪些" tabindex="-1"><a class="header-anchor" href="#_36-http-常见请求方法有哪些" aria-hidden="true">#</a> 36. http 常见请求方法有哪些？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_37-列举优化网络性能方法" tabindex="-1"><a class="header-anchor" href="#_37-列举优化网络性能方法" aria-hidden="true">#</a> 37. 列举优化网络性能方法</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
...
<h2 id="_38-session-怎么消除" tabindex="-1"><a class="header-anchor" href="#_38-session-怎么消除" aria-hidden="true">#</a> 38. session 怎么消除</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_39-什么是-dns-域名解析" tabindex="-1"><a class="header-anchor" href="#_39-什么是-dns-域名解析" aria-hidden="true">#</a> 39. 什么是 DNS 域名解析？</h2>
<blockquote>
<p>参考答案：</p>
