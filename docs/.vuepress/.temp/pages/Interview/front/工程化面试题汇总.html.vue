<template><h1 id="工程化面试题汇总" tabindex="-1"><a class="header-anchor" href="#工程化面试题汇总" aria-hidden="true">#</a> 工程化面试题汇总</h1>
<p><img src="imgs/enginerring.jpg" alt="enginerring"></p>
<h2 id="_1-下面的模块导出了什么结果" tabindex="-1"><a class="header-anchor" href="#_1-下面的模块导出了什么结果" aria-hidden="true">#</a> 1. 下面的模块导出了什么结果？</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>exports<span class="token punctuation">.</span>a <span class="token operator">=</span> <span class="token string">"a"</span><span class="token punctuation">;</span>
...
<h2 id="_2-说一下你对前端工程化-模块化-组件化的理解" tabindex="-1"><a class="header-anchor" href="#_2-说一下你对前端工程化-模块化-组件化的理解" aria-hidden="true">#</a> 2. 说一下你对前端工程化，模块化，组件化的理解？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_3-webpack-和-gulp-的区别是什么" tabindex="-1"><a class="header-anchor" href="#_3-webpack-和-gulp-的区别是什么" aria-hidden="true">#</a> 3. webpack 和 gulp 的区别是什么？</h2>
<blockquote>
<p>直播讲解</p>
</blockquote>
<blockquote>
...
<h2 id="_4-webpack-中的-loader-属性和-plugins-属性的区别是什么" tabindex="-1"><a class="header-anchor" href="#_4-webpack-中的-loader-属性和-plugins-属性的区别是什么" aria-hidden="true">#</a> 4. webpack 中的 loader 属性和 plugins 属性的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_5-webpack-的核心概念都有哪些" tabindex="-1"><a class="header-anchor" href="#_5-webpack-的核心概念都有哪些" aria-hidden="true">#</a> 5. webpack 的核心概念都有哪些？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
...
<h2 id="_6-commonjs-和-es6-模块的区别是什么" tabindex="-1"><a class="header-anchor" href="#_6-commonjs-和-es6-模块的区别是什么" aria-hidden="true">#</a> 6. commonjs 和 es6 模块的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_7-es6-中如何实现模块化的异步加载" tabindex="-1"><a class="header-anchor" href="#_7-es6-中如何实现模块化的异步加载" aria-hidden="true">#</a> 7. ES6 中如何实现模块化的异步加载？</h2>
<blockquote>
<p>参考答案：</p>
<p>使用动态导入即可，导入后，得到的是一个 Promise，完成后，得到一个模块对象，其中包含了所有的导出结果。</p>
</blockquote>
<h2 id="_8-说一下-webpack-中的几种-hash-的实现原理是什么" tabindex="-1"><a class="header-anchor" href="#_8-说一下-webpack-中的几种-hash-的实现原理是什么" aria-hidden="true">#</a> 8. 说一下 webpack 中的几种 hash 的实现原理是什么？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
...
<h2 id="_9-webpack-如果使用了-hash-命名-那是每次都会重新生成-hash-吗" tabindex="-1"><a class="header-anchor" href="#_9-webpack-如果使用了-hash-命名-那是每次都会重新生成-hash-吗" aria-hidden="true">#</a> 9. webpack 如果使用了 hash 命名，那是每次都会重新生成 hash 吗？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_10-webpack-中是如何处理图片的-抖音直播" tabindex="-1"><a class="header-anchor" href="#_10-webpack-中是如何处理图片的-抖音直播" aria-hidden="true">#</a> 10. webpack 中是如何处理图片的？ （抖音直播）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_11-webpack-打包出来的-html-为什么-style-放在头部-script-放在底部" tabindex="-1"><a class="header-anchor" href="#_11-webpack-打包出来的-html-为什么-style-放在头部-script-放在底部" aria-hidden="true">#</a> 11. webpack 打包出来的 html 为什么 style 放在头部 script 放在底部？</h2>
<blockquote>
...
<h2 id="_12-webpack-配置如何实现开发环境不使用-cdn、生产环境使用-cdn" tabindex="-1"><a class="header-anchor" href="#_12-webpack-配置如何实现开发环境不使用-cdn、生产环境使用-cdn" aria-hidden="true">#</a> 12. webpack 配置如何实现开发环境不使用 cdn、生产环境使用 cdn？</h2>
<blockquote>
<p>要配置 CDN，有两个步骤：</p>
<ol>
...
<h2 id="_13-介绍一下-webpack4-中的-tree-shaking-的工作流程" tabindex="-1"><a class="header-anchor" href="#_13-介绍一下-webpack4-中的-tree-shaking-的工作流程" aria-hidden="true">#</a> 13. 介绍一下 webpack4 中的 tree-shaking 的工作流程？</h2>
<blockquote>
<p>推荐阅读：https://tsejx.github.io/webpack-guidebook/principle-analysis/operational-principle/tree-shaking</p>
</blockquote>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_14-说一下-webpack-loader-的作用是什么" tabindex="-1"><a class="header-anchor" href="#_14-说一下-webpack-loader-的作用是什么" aria-hidden="true">#</a> 14. 说一下 webpack loader 的作用是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_15-在开发过程中如果需要对已有模块进行扩展-如何进行开发保证调用方不受影响" tabindex="-1"><a class="header-anchor" href="#_15-在开发过程中如果需要对已有模块进行扩展-如何进行开发保证调用方不受影响" aria-hidden="true">#</a> 15. 在开发过程中如果需要对已有模块进行扩展，如何进行开发保证调用方不受影响？</h2>
<blockquote>
<p>参考答案：</p>
<p>实际上就是一个版本管理的问题。</p>
...
<h2 id="_16-export-和-export-default-的区别是什么" tabindex="-1"><a class="header-anchor" href="#_16-export-和-export-default-的区别是什么" aria-hidden="true">#</a> 16. export 和 export default 的区别是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_17-webpack-打包原理是什么" tabindex="-1"><a class="header-anchor" href="#_17-webpack-打包原理是什么" aria-hidden="true">#</a> 17. webpack 打包原理是什么？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_18-webpack-热更新原理是什么" tabindex="-1"><a class="header-anchor" href="#_18-webpack-热更新原理是什么" aria-hidden="true">#</a> 18. webpack 热更新原理是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_19-如何优化-webpack-的打包速度" tabindex="-1"><a class="header-anchor" href="#_19-如何优化-webpack-的打包速度" aria-hidden="true">#</a> 19. 如何优化 webpack 的打包速度？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_20-webpack-如何实现动态导入" tabindex="-1"><a class="header-anchor" href="#_20-webpack-如何实现动态导入" aria-hidden="true">#</a> 20. webpack 如何实现动态导入？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_21-说一下-webpack-有哪几种文件指纹" tabindex="-1"><a class="header-anchor" href="#_21-说一下-webpack-有哪几种文件指纹" aria-hidden="true">#</a> 21. 说一下 webpack 有哪几种文件指纹</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
...
<h2 id="_22-常用的-webpack-loader-都有哪些" tabindex="-1"><a class="header-anchor" href="#_22-常用的-webpack-loader-都有哪些" aria-hidden="true">#</a> 22. 常用的 webpack Loader 都有哪些？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_23-说一下-webpack-常用插件都有哪些" tabindex="-1"><a class="header-anchor" href="#_23-说一下-webpack-常用插件都有哪些" aria-hidden="true">#</a> 23. 说一下 webpack 常用插件都有哪些？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_24-使用-babel-loader-会有哪些问题-可以怎样优化" tabindex="-1"><a class="header-anchor" href="#_24-使用-babel-loader-会有哪些问题-可以怎样优化" aria-hidden="true">#</a> 24. 使用 babel-loader 会有哪些问题，可以怎样优化？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_25-babel-是如何对-class-进行编译的" tabindex="-1"><a class="header-anchor" href="#_25-babel-是如何对-class-进行编译的" aria-hidden="true">#</a> 25. babel 是如何对 class 进行编译的？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_26-解释一下-babel-polyfill-的作用是什么" tabindex="-1"><a class="header-anchor" href="#_26-解释一下-babel-polyfill-的作用是什么" aria-hidden="true">#</a> 26. 解释一下 babel-polyfill 的作用是什么？</h2>
<blockquote>
<p>说明：</p>
...
<h2 id="_27-解释一下-less-的-的操作符是做什么用的" tabindex="-1"><a class="header-anchor" href="#_27-解释一下-less-的-的操作符是做什么用的" aria-hidden="true">#</a> 27. 解释一下 less 的&amp;的操作符是做什么用的？</h2>
<blockquote>
<p>参考答案：</p>
<p>&amp;符号后面的内容会和父级选择器合并书写，即中间不加入空格字符</p>
</blockquote>
<h2 id="_28-在前端工程化中-可以进行哪些方面的优化" tabindex="-1"><a class="header-anchor" href="#_28-在前端工程化中-可以进行哪些方面的优化" aria-hidden="true">#</a> 28. 在前端工程化中，可以进行哪些方面的优化？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_29-如果有一个工程打包特别大-如何进行优化" tabindex="-1"><a class="header-anchor" href="#_29-如果有一个工程打包特别大-如何进行优化" aria-hidden="true">#</a> 29. 如果有一个工程打包特别大-如何进行优化？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_30-webpack-怎么进行首屏加载的优化" tabindex="-1"><a class="header-anchor" href="#_30-webpack-怎么进行首屏加载的优化" aria-hidden="true">#</a> 30. webpack 怎么进行首屏加载的优化？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_31-介绍一下-webpack-scope-hoisting" tabindex="-1"><a class="header-anchor" href="#_31-介绍一下-webpack-scope-hoisting" aria-hidden="true">#</a> 31. 介绍一下 webpack scope hoisting？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_32-webpack-proxy-工作原理-为什么能解决跨域" tabindex="-1"><a class="header-anchor" href="#_32-webpack-proxy-工作原理-为什么能解决跨域" aria-hidden="true">#</a> 32. webpack proxy 工作原理，为什么能解决跨域？</h2>
<blockquote>
<p>说明：</p>
...
<h2 id="_33-组件发布的是不是所有依赖这个组件库的项目都需要升级" tabindex="-1"><a class="header-anchor" href="#_33-组件发布的是不是所有依赖这个组件库的项目都需要升级" aria-hidden="true">#</a> 33. 组件发布的是不是所有依赖这个组件库的项目都需要升级？</h2>
<blockquote>
<p>参考答案：</p>
<p>实际上就是一个版本管理的问题。</p>
<p>如果此次模块升级只是修复了某一些 bug，作为补丁版本升级即可，不影响主版本和次版本号</p>
...
<h2 id="_34-开发过程中-如何进行公共组件的设计-字节跳动" tabindex="-1"><a class="header-anchor" href="#_34-开发过程中-如何进行公共组件的设计-字节跳动" aria-hidden="true">#</a> 34. 开发过程中，如何进行公共组件的设计？（字节跳动）</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_35-说一下项目里有做过哪些-webpack-上的优化-字节跳动" tabindex="-1"><a class="header-anchor" href="#_35-说一下项目里有做过哪些-webpack-上的优化-字节跳动" aria-hidden="true">#</a> 35. 说一下项目里有做过哪些 webpack 上的优化（字节跳动）</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_36-具体说一下-splitchunksplugin-的使用场景及使用方法。-字节跳动" tabindex="-1"><a class="header-anchor" href="#_36-具体说一下-splitchunksplugin-的使用场景及使用方法。-字节跳动" aria-hidden="true">#</a> 36. 具体说一下 splitchunksplugin 的使用场景及使用方法。（字节跳动）</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
...
<h2 id="_37-描述一下-webpack-的构建流程-cvte" tabindex="-1"><a class="header-anchor" href="#_37-描述一下-webpack-的构建流程-cvte" aria-hidden="true">#</a> 37. 描述一下 webpack 的构建流程？（CVTE）</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li><strong>初始化参数</strong>：从配置文件和 Shell 语句中读取与合并参数，得出最终的参数</li>
...
<h2 id="_38-解释一下-webpack-插件的实现原理-cvte" tabindex="-1"><a class="header-anchor" href="#_38-解释一下-webpack-插件的实现原理-cvte" aria-hidden="true">#</a> 38. 解释一下 webpack 插件的实现原理？（CVTE）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_39-有用过哪些插件做项目的分析吗-cvte" tabindex="-1"><a class="header-anchor" href="#_39-有用过哪些插件做项目的分析吗-cvte" aria-hidden="true">#</a> 39. 有用过哪些插件做项目的分析吗？（CVTE）</h2>
<blockquote>
<p>参考答案：</p>
<p>用过 webpack-bundle-analyzer 分析过打包结果，主要用于优化项目打包体积</p>
</blockquote>
<h2 id="_40-什么是-babel-有什么作用" tabindex="-1"><a class="header-anchor" href="#_40-什么是-babel-有什么作用" aria-hidden="true">#</a> 40. 什么是 babel，有什么作用？</h2>
<blockquote>
<p>参考答案：</p>
<p>babel 是一个 JS 编译器，主要用于将下一代的 JS 语言代码编译成兼容性更好的代码。</p>
<p>它其实本身做的事情并不多，它负责将 JS 代码编译成为 AST，然后依托其生态中的各种插件对 AST 中的语法和 API 进行处理</p>
</blockquote>
<h2 id="_41-解释一下-npm-模块安装机制是什么" tabindex="-1"><a class="header-anchor" href="#_41-解释一下-npm-模块安装机制是什么" aria-hidden="true">#</a> 41. 解释一下 npm 模块安装机制是什么？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
