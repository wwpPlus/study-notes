<template><h1 id="css-面试题汇总" tabindex="-1"><a class="header-anchor" href="#css-面试题汇总" aria-hidden="true">#</a> CSS 面试题汇总</h1>
<p><img src="imgs/css.jpg" alt="css"></p>
<h2 id="_1-介绍下-bfc-及其应用" tabindex="-1"><a class="header-anchor" href="#_1-介绍下-bfc-及其应用" aria-hidden="true">#</a> 1. 介绍下 <em>BFC</em> 及其应用</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_2-介绍下-bfc、ifc、gfc-和-ffc" tabindex="-1"><a class="header-anchor" href="#_2-介绍下-bfc、ifc、gfc-和-ffc" aria-hidden="true">#</a> 2. 介绍下 <em>BFC、IFC、GFC</em> 和 <em>FFC</em></h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_3-flex-布局如何使用" tabindex="-1"><a class="header-anchor" href="#_3-flex-布局如何使用" aria-hidden="true">#</a> 3. <em>flex</em> 布局如何使用？</h2>
<blockquote>
<p>参考答案：</p>
...
<li>align-self 属性允许单个项目有与其他项目不一样的对齐方式，可覆盖 align-items 属性。默认值为 <em>auto</em>，表示继承父元素的 align-items 属性，如果没有父元素，则等同于 stretch。</li>
</ul>
</blockquote>
<h2 id="_4-怎么让一个-div-水平垂直居中" tabindex="-1"><a class="header-anchor" href="#_4-怎么让一个-div-水平垂直居中" aria-hidden="true">#</a> 4. 怎么让一个 <em>div</em> 水平垂直居中</h2>
<blockquote>
<p>参考答案：</p>
<p>水平垂直居中有好多种实现方式，主要就分为两类不定宽高和定宽高 以在 <em>body</em> 下插入一个 <em>div</em> 为例</p>
<p><strong>定宽高</strong></p>
<p>使用定位 + <em>margin</em></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>element<span class="token punctuation">.</span>style <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>使用定位 + <em>transfrom</em></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>element<span class="token punctuation">.</span>style <span class="token punctuation">{</span>
 <span class="token literal-property property">position</span><span class="token operator">:</span> absolute<span class="token punctuation">;</span>
 <span class="token literal-property property">left</span><span class="token operator">:</span> <span class="token number">50</span><span class="token operator">%</span><span class="token punctuation">;</span>
 <span class="token literal-property property">top</span><span class="token operator">:</span> <span class="token number">50</span><span class="token operator">%</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p><strong>不定宽高</strong></p>
...
<h2 id="_5-分析比较-opacity-0、visibility-hidden、display-none-优劣和适用场景。" tabindex="-1"><a class="header-anchor" href="#_5-分析比较-opacity-0、visibility-hidden、display-none-优劣和适用场景。" aria-hidden="true">#</a> 5. 分析比较 <em>opacity: 0、visibility: hidden、display: none</em> 优劣和适用场景。</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>结构： display: none : 会让元素完全从渲染树中消失，渲染的时候不占据任何空间, 不能点击， visibility: hidden:不会让元素从渲染树消失，渲染元素继续占据空间，只是内容不可见，不能点击 opacity: 0: 不会让元素从渲染树消失，渲染元素继续占据空间，只是内容不可见，可以点击</p>
</li>
<li>
<p>继承： display: none 和 opacity: 0：是非继承属性，子孙节点消失由于元素从渲染树消失造成，通过修改子孙节点属性无法显示。 visibility: hidden：是继承属性，子孙节点消失由于继承了 hidden，通过设置 visibility: visible;可以让子孙节点显式。</p>
</li>
<li>
<p>性能： display: none : 修改元素会造成文档回流,读屏器不会读取 display: none 元素内容，性能消耗较大 visibility: hidden: 修改元素只会造成本元素的重绘,性能消耗较少读屏器读取 visibility: hidden 元素内容 opacity: 0 ： 修改元素会造成重绘，性能消耗较少</p>
</li>
</ul>
</blockquote>
<h2 id="_6-已知如下代码-如何修改才能让图片宽度为-300px-注意下面代码不可修改。" tabindex="-1"><a class="header-anchor" href="#_6-已知如下代码-如何修改才能让图片宽度为-300px-注意下面代码不可修改。" aria-hidden="true">#</a> 6. 已知如下代码，如何修改才能让图片宽度为 <em>300px</em> ？注意下面代码不可修改。</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>img src<span class="token operator">=</span><span class="token string">"1.jpg"</span> style<span class="token operator">=</span>"width<span class="token operator">:</span>480px<span class="token operator">!</span>important<span class="token punctuation">;</span>”<span class="token operator">></span>
...
<h2 id="_7-如何用-css-或-js-实现多行文本溢出省略效果-考虑兼容性" tabindex="-1"><a class="header-anchor" href="#_7-如何用-css-或-js-实现多行文本溢出省略效果-考虑兼容性" aria-hidden="true">#</a> 7. 如何用 <em>css</em> 或 <em>js</em> 实现多行文本溢出省略效果，考虑兼容性</h2>
<blockquote>
<p>参考答案：</p>
<p>CSS 实现方式</p>
<p>单行：</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">overflow</span><span class="token punctuation">:</span> hidden<span class="token punctuation">;</span>
<span class="token property">text-overflow</span><span class="token punctuation">:</span> ellipsis<span class="token punctuation">;</span>
<span class="token property">white-space</span><span class="token punctuation">:</span> nowrap<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>多行：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>兼容：</p>
...
<h2 id="_8-居中为什么要使用-transform-为什么不使用-marginleft-top-阿里" tabindex="-1"><a class="header-anchor" href="#_8-居中为什么要使用-transform-为什么不使用-marginleft-top-阿里" aria-hidden="true">#</a> 8. 居中为什么要使用 <em>transform</em>（为什么不使用 <em>marginLeft/Top</em>）（阿里）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_9-介绍下粘性布局-sticky-网易" tabindex="-1"><a class="header-anchor" href="#_9-介绍下粘性布局-sticky-网易" aria-hidden="true">#</a> 9. 介绍下粘性布局（<em>sticky</em>）（网易）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_10-说出-space-between-和-space-around-的区别-携程" tabindex="-1"><a class="header-anchor" href="#_10-说出-space-between-和-space-around-的区别-携程" aria-hidden="true">#</a> 10. 说出 <em>space-between</em> 和 <em>space-around</em> 的区别？（携程）</h2>
<blockquote>
<p>参考答案：</p>
<p>这个是 <em>flex</em> 布局的内容，其实就是一个边距的区别，按水平布局来说，<code>space-between</code>是两端对齐，在左右两侧没有边距，而<code>space-around</code>是每个 子项目左右方向的 margin 相等，所以两个 item 中间的间距会比较大。</p>
<p>如图所示：</p>
<img src="https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2021-11-03-010805.png" alt="image-20210816161354713" style="width:50%;" />
</blockquote>
<h2 id="_11-css3-中-transition-和-animation-的属性分别有哪些-哔哩哔哩" tabindex="-1"><a class="header-anchor" href="#_11-css3-中-transition-和-animation-的属性分别有哪些-哔哩哔哩" aria-hidden="true">#</a> 11. <em>CSS3</em> 中 <em>transition</em> 和 <em>animation</em> 的属性分别有哪些（哔哩哔哩）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_12-隐藏页面中的某个元素的方法有哪些" tabindex="-1"><a class="header-anchor" href="#_12-隐藏页面中的某个元素的方法有哪些" aria-hidden="true">#</a> 12. 隐藏页面中的某个元素的方法有哪些？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>隐藏类型</li>
...
<p>(1) display 属性</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">display</span><span class="token punctuation">:</span> none<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>(2) hidden 属性
HTML5 新增属性，相当于 display: none</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">hidden</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p><strong>视觉上的隐藏</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>(2) 设置 position 为 relative，通过设置 top、left 等值，将其移出可视区域。</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">position</span><span class="token punctuation">:</span> relative<span class="token punctuation">;</span>
<span class="token property">left</span><span class="token punctuation">:</span> -99999px<span class="token punctuation">;</span>
<span class="token property">height</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>(3) 设置 margin 值，将其移出可视区域范围（可视区域占位）。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>margin<span class="token operator">-</span>left<span class="token operator">:</span> <span class="token operator">-</span>99999px<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>语义上隐藏</p>
<p><em>aria-hidden 属性</em></p>
<p>读屏软件不可读，占据空间，可见。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>div aria<span class="token operator">-</span>hidden<span class="token operator">=</span><span class="token string">"true"</span><span class="token operator">></span><span class="token operator">&lt;</span><span class="token operator">/</span>div<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></blockquote>
<h2 id="_13-层叠上下文" tabindex="-1"><a class="header-anchor" href="#_13-层叠上下文" aria-hidden="true">#</a> 13. 层叠上下文</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_14-分析比较-opacity-0、visibility-hidden、display-none-优劣和适用场景" tabindex="-1"><a class="header-anchor" href="#_14-分析比较-opacity-0、visibility-hidden、display-none-优劣和适用场景" aria-hidden="true">#</a> 14. 分析比较 <em>opacity: 0、visibility: hidden、display: none</em> 优劣和适用场景</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_15-讲一下png8、png16、png32的区别-并简单讲讲-png-的压缩原理" tabindex="-1"><a class="header-anchor" href="#_15-讲一下png8、png16、png32的区别-并简单讲讲-png-的压缩原理" aria-hidden="true">#</a> 15. 讲一下<em>png8、png16、png32</em>的区别，并简单讲讲 <em>png</em> 的压缩原理</h2>
<blockquote>
<p>参考答案：</p>
<p>PNG 图片主要有三个类型，分别为 PNG 8/ PNG 24 / PNG 32。</p>
<ul>
<li><code>PNG 8</code>：PNG 8 中的 8，其实指的是 8bits，相当于用 2^8（2 的 8 次方）大小来存储一张图片的颜色种类，2^8 等于 256，也就是说 PNG 8 能存储 256 种颜色，一张图片如果颜色种类很少，将它设置成 PNG 8 得图片类型是非常适合的。</li>
<li><code>PNG 24</code>：PNG 24 中的 24，相当于 3 乘以 8 等于 24，就是用三个 8bits 分别去表示 R（红）、G（绿）、B（蓝）。R(0-255),G(0-255),B(0-255)，可以表达 256 乘以 256 乘以 256=16777216 种颜色的图片，这样 PNG 24 就能比 PNG 8 表示色彩更丰富的图片。但是所占用的空间相对就更大了。</li>
<li><code>PNG 32</code>：PNG 32 中的 32，相当于 PNG 24 加上 8bits 的透明颜色通道，就相当于 R（红）、G（绿）、B（蓝）、A（透明）。R(0~255),G(0~255),B(0~255),A(0~255)。比 PNG 24 多了一个 A（透明），也就是说 PNG 32 能表示跟 PNG 24 一样多的色彩，并且还支持 256 种透明的颜色，能表示更加丰富的图片颜色类型。</li>
</ul>
<p>PNG 图片的压缩，分两个阶段：</p>
<ul>
<li><code>预解析（Prediction）</code>：这个阶段就是对 png 图片进行一个预处理，处理后让它更方便后续的压缩。</li>
<li><code>压缩（Compression）</code>：执行 Deflate 压缩，该算法结合了 LZ77 算法和 Huffman 算法对图片进行编码。</li>
</ul>
</blockquote>
<h2 id="_16-说说渐进增强和优雅降级" tabindex="-1"><a class="header-anchor" href="#_16-说说渐进增强和优雅降级" aria-hidden="true">#</a> 16. 说说渐进增强和优雅降级</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_17-介绍下-positon-属性" tabindex="-1"><a class="header-anchor" href="#_17-介绍下-positon-属性" aria-hidden="true">#</a> 17. 介绍下 <em>positon</em> 属性</h2>
<blockquote>
<p>参考答案：</p>
<p>position 属性主要用来定位，常见的属性值如下：</p>
<ul>
<li>
<p><code>absolute</code> 绝对定位，相对于 <code>static</code> 定位以外的第一个父元素进行定位。</p>
</li>
<li>
<p><code>relative</code> 相对定位，相对于其自身正常位置进行定位。</p>
</li>
<li>
...
<li>
<p><code>sticky</code> 粘性定位，当元素在容器中被滚动超过指定的偏移值时，元素在容器内固定在指定位置。</p>
</li>
</ul>
</blockquote>
<h2 id="_18-如何用-css-实现一个三角形" tabindex="-1"><a class="header-anchor" href="#_18-如何用-css-实现一个三角形" aria-hidden="true">#</a> 18. 如何用 <em>CSS</em> 实现一个三角形</h2>
<blockquote>
<p>参考答案：</p>
<p>可以利用 border 属性</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
...
<h2 id="_19-如何实现一个自适应的正方形" tabindex="-1"><a class="header-anchor" href="#_19-如何实现一个自适应的正方形" aria-hidden="true">#</a> 19. 如何实现一个自适应的正方形</h2>
<blockquote>
<p>参考答案：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p><strong>方法 2：利用 margin 或者 padding 的百分比计算是参照父元素的 width 属性</strong></p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.square</span> <span class="token punctuation">{</span>
 ...
 <span class="token property">height</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span> // 防止内容撑开多余的高度
 <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<h2 id="_20-如何实现三栏布局" tabindex="-1"><a class="header-anchor" href="#_20-如何实现三栏布局" aria-hidden="true">#</a> 20. 如何实现三栏布局</h2>
<blockquote>
<p>参考答案：</p>
...
<span class="token selector">.right</span><span class="token punctuation">{</span>
 ...
 <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p><strong>第二种：position + margin</strong></p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>container<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>left<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>left<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>right<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>right<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>main<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>main<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">body,html</span><span class="token punctuation">{</span>
...
<h2 id="_21-import-和-link-区别" tabindex="-1"><a class="header-anchor" href="#_21-import-和-link-区别" aria-hidden="true">#</a> 21. <em>import</em> 和 <em>link</em> 区别</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>从属关系区别</li>
</ol>
<p><code>@import</code>是 CSS 提供的语法规则，只有导入样式表的作用；<code>link</code>是 HTML 提供的标签，不仅可以加载 CSS 文件，还可以定义 RSS、rel 连接属性等。</p>
<ol start="2">
<li>加载顺序区别</li>
</ol>
...
<p>可以通过 JS 操作 DOM ，插入<code>link</code>标签来改变样式；由于 DOM 方法是基于文档的，无法使用<code>@import</code>的方式插入样式。</p>
</blockquote>
<h2 id="_22-说说你对-bfc-的理解" tabindex="-1"><a class="header-anchor" href="#_22-说说你对-bfc-的理解" aria-hidden="true">#</a> 22. 说说你对 <em>BFC</em> 的理解</h2>
<blockquote>
<p>参考答案：</p>
<p>块级格式化上下文 <em>Block Formatting Context</em> 是 CSS 规范中一个概念，决定元素的内容如何渲染以及与其他元素的关系。存在 5 条规则：</p>
<ol>
...
<h2 id="_23-清除浮动的方法" tabindex="-1"><a class="header-anchor" href="#_23-清除浮动的方法" aria-hidden="true">#</a> 23. 清除浮动的方法</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>clear 清除浮动（添加空 div 法）在浮动元素下方添加空 div，并给该元素写 css 样式： {clear:both;height:0;overflow:hidden;}</p>
</li>
<li>
<p>给浮动元素父级设置高度</p>
</li>
...
<li>
<p>父级设置成 inline-block，其 margin: 0 auto 居中方式失效</p>
</li>
<li>
<p>给父级添加 overflow:hidden 清除浮动方法</p>
</li>
<li>
<p>万能清除法 after 伪类清浮动（现在主流方法，推荐使用）</p>
</li>
</ul>
</blockquote>
<h2 id="_24-说说选择器的权重计算方式" tabindex="-1"><a class="header-anchor" href="#_24-说说选择器的权重计算方式" aria-hidden="true">#</a> 24. 说说选择器的权重计算方式</h2>
<blockquote>
<p>参考答案：</p>
<p><em>!important</em> 最高，* 为 0，行内样式 A 组加一，id 选择器 B 组加一，类、伪类、属性选择器 C 组加一，元素、伪元素 D 组加一。</p>
...
<h2 id="_25-css-reset-和-normalize-css-有什么区别" tabindex="-1"><a class="header-anchor" href="#_25-css-reset-和-normalize-css-有什么区别" aria-hidden="true">#</a> 25. <em>css reset</em> 和 <em>normalize.css</em> 有什么区别？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>两者都是通过重置样式，保持浏览器样式的一致性</p>
</li>
<li>
<p>前者几乎为所有标签添加了样式，后者保持了许多浏览器样式，保持尽可能的一致</p>
</li>
<li>
<p>后者修复了常见的桌面端和移动端浏览器的 bug：包含了 HTML5 元素的显示设置、预格式化文字的 font-size 问题、在 IE9 中 SVG 的溢出、许多出现在各浏览器和操作系统中的与表单相关的 bug。</p>
</li>
<li>
<p>前者中含有大段的继承链</p>
</li>
...
<h2 id="_26-说说两种盒模型以及区别" tabindex="-1"><a class="header-anchor" href="#_26-说说两种盒模型以及区别" aria-hidden="true">#</a> 26. 说说两种盒模型以及区别</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_27-如何避免重绘或者重排" tabindex="-1"><a class="header-anchor" href="#_27-如何避免重绘或者重排" aria-hidden="true">#</a> 27. 如何避免重绘或者重排？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 判断是否是黑色系样式</span>
<span class="token keyword">const</span> theme <span class="token operator">=</span> isDark <span class="token operator">?</span> <span class="token string">'dark'</span> <span class="token operator">:</span> <span class="token string">'light'</span>

<span class="token comment">// 根据判断来设置不同的class</span>
ele<span class="token punctuation">.</span><span class="token function">setAttribute</span><span class="token punctuation">(</span><span class="token string">'className'</span><span class="token punctuation">,</span> theme<span class="token punctuation">)</span>
...
<h2 id="_28-如何触发重排和重绘" tabindex="-1"><a class="header-anchor" href="#_28-如何触发重排和重绘" aria-hidden="true">#</a> 28. 如何触发重排和重绘？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_29-重绘与重排的区别" tabindex="-1"><a class="header-anchor" href="#_29-重绘与重排的区别" aria-hidden="true">#</a> 29. 重绘与重排的区别？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_30-如何优化图片" tabindex="-1"><a class="header-anchor" href="#_30-如何优化图片" aria-hidden="true">#</a> 30. 如何优化图片</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>
<p>对于很多装饰类图片，尽量不用图片，因为这类修饰图片完全可以用 CSS 去代替。</p>
</li>
<li>
<p>对于移动端来说，屏幕宽度就那么点，完全没有必要去加载原图浪费带宽。一般图片都用 CDN 加载，可以计算出适配屏幕的宽度，然后去请求相应裁剪好的图片。</p>
</li>
<li>
<p>小图使用 <em>base64</em> 格式</p>
</li>
<li>
...
<h2 id="_31-说说重绘-repaint-和回流-reflow" tabindex="-1"><a class="header-anchor" href="#_31-说说重绘-repaint-和回流-reflow" aria-hidden="true">#</a> 31. 说说重绘（Repaint）和回流（Reflow）</h2>
<blockquote>
<p>参考答案：</p>
<p>请参阅前面 <em>28、29、30</em> 题。</p>
</blockquote>
<h2 id="_32-你能描述一下渐进增强和优雅降级之间的不同吗" tabindex="-1"><a class="header-anchor" href="#_32-你能描述一下渐进增强和优雅降级之间的不同吗" aria-hidden="true">#</a> 32. 你能描述一下渐进增强和优雅降级之间的不同吗?</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_33-如何在页面上实现一个圆形的可点击区域" tabindex="-1"><a class="header-anchor" href="#_33-如何在页面上实现一个圆形的可点击区域" aria-hidden="true">#</a> 33. 如何在页面上实现一个圆形的可点击区域？</h2>
<blockquote>
<p>参考答案：</p>
<p>首先使用 <em>CSS3</em> 新增的 <em>border-radius</em> 属性来将一个区域变成圆形，然后再使用 <em>JS</em> 来绑定事件。</p>
</blockquote>
<h2 id="_34-什么是渐进式渲染-progressive-rendering" tabindex="-1"><a class="header-anchor" href="#_34-什么是渐进式渲染-progressive-rendering" aria-hidden="true">#</a> 34. 什么是渐进式渲染（<em>progressive rendering</em>）？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_35-css3-新增了那些东西" tabindex="-1"><a class="header-anchor" href="#_35-css3-新增了那些东西" aria-hidden="true">#</a> 35. <em>CSS3</em> 新增了那些东西？</h2>
<blockquote>
<p>参考答案：</p>
...
<li>渐变：线性渐变、径向渐变</li>
<li>字体：<em>@font-face</em></li>
<li>2D/3D 转换：<em>transform、transform-origin</em></li>
<li>过渡与动画：<em>transition、@keyframes、animation</em></li>
<li>多列布局</li>
<li>媒体查询</li>
</ul>
</blockquote>
<h2 id="_36-我想实现一根只有-1px-的长线怎么实现" tabindex="-1"><a class="header-anchor" href="#_36-我想实现一根只有-1px-的长线怎么实现" aria-hidden="true">#</a> 36. 我想实现一根只有 <em>1px</em> 的长线怎么实现?</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_37-三角形怎么实现-要设置宽高吗" tabindex="-1"><a class="header-anchor" href="#_37-三角形怎么实现-要设置宽高吗" aria-hidden="true">#</a> 37. 三角形怎么实现？要设置宽高吗？</h2>
<blockquote>
<p>参考答案：</p>
<p>设置块级元素宽高为 0，边框 3 条设置为透明色。具体可以参阅第 18 题答案</p>
</blockquote>
<h2 id="_38-box-sizing-有什么作用" tabindex="-1"><a class="header-anchor" href="#_38-box-sizing-有什么作用" aria-hidden="true">#</a> 38. <em>box-sizing</em> 有什么作用？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>box-sizing</em> 是用于告诉浏览器如何计算一个元素是总宽度和总高度，主要用来切换标准盒模型和 IE 盒子。</p>
<ul>
<li>
<p>标准盒模型 box-sizing: content-box
content-box:
width = content width;
height = content height</p>
</li>
<li>
<p>IE 盒模型 box-sizing: border-box
border-box:
...
<h2 id="_39-img-标签在页面中有-1px-的边框-怎么处理" tabindex="-1"><a class="header-anchor" href="#_39-img-标签在页面中有-1px-的边框-怎么处理" aria-hidden="true">#</a> 39. <em>img</em> 标签在页面中有 <em>1px</em> 的边框，怎么处理</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_40-如何绝对居中-不用定位-看书网" tabindex="-1"><a class="header-anchor" href="#_40-如何绝对居中-不用定位-看书网" aria-hidden="true">#</a> 40. 如何绝对居中（不用定位）（看书网）</h2>
<blockquote>
<p>参考答案：</p>
<p>方法一：</p>
...
<h2 id="_41-css-选择器权重值" tabindex="-1"><a class="header-anchor" href="#_41-css-选择器权重值" aria-hidden="true">#</a> 41. <em>CSS</em> 选择器权重值</h2>
<blockquote>
<p>参考答案：</p>
<p>请参阅前面第 <em>24</em> 题答案。</p>
</blockquote>
<h2 id="_42-我有-5-个-div-在一行-我要让-div-与-div-直接间距-10px-且最左最右两边的-div-据边框-10px-同时在我改变窗口大小时-这个-10px-不能变-div-根据窗口改变大小-长天星斗" tabindex="-1"><a class="header-anchor" href="#_42-我有-5-个-div-在一行-我要让-div-与-div-直接间距-10px-且最左最右两边的-div-据边框-10px-同时在我改变窗口大小时-这个-10px-不能变-div-根据窗口改变大小-长天星斗" aria-hidden="true">#</a> 42. 我有 5 个 div 在一行，我要让 div 与 div 直接间距 10px 且最左最右两边的 div 据边框 10px，同时在我改变窗口大小时，这个 10px 不能变，div 根据窗口改变大小（长天星斗）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_43-bootstrap-响应式的原理是什么" tabindex="-1"><a class="header-anchor" href="#_43-bootstrap-响应式的原理是什么" aria-hidden="true">#</a> 43. <em>bootstrap</em> 响应式的原理是什么</h2>
<blockquote>
<p>参考答案：</p>
<p><em>bootstrap</em> 使用的是栅格布局。栅格布局的实现原理，是通过定义容器大小，平分 <em>12</em> 份，再调整内外边距，最后结合媒体查询，就制作出了强大的响应式网格系统。</p>
</blockquote>
<h2 id="_44-如何做响应式" tabindex="-1"><a class="header-anchor" href="#_44-如何做响应式" aria-hidden="true">#</a> 44. 如何做响应式？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_45-什么是响应式设计" tabindex="-1"><a class="header-anchor" href="#_45-什么是响应式设计" aria-hidden="true">#</a> 45. 什么是响应式设计</h2>
<blockquote>
<p>参考答案：</p>
...
<p>为了适应屏幕，多数的移动浏览器会把 HTML 网页缩放到设备屏幕的宽度。你可以使用 meta 标签的 viewport 属性来设置。下面的代码告诉浏览器使用设备屏幕宽度作为内容的宽度，并且忽视初始的宽度设置。这段代码写在 <code>&lt;head&gt;</code>里面</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>IE8 及以下的浏览器不支持 media query。你可以使用 media-queries.js 或 respond.js 。这样 IE 就能支持 media query 了。</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token comment">&lt;!--[if lt IE 9]> &lt;script src="http://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js">&lt;/script> &lt;![endif]--></span>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token atrule"><span class="token rule">@media</span> screen <span class="token keyword">and</span> <span class="token punctuation">(</span><span class="token property">max-width</span><span class="token punctuation">:</span> 300px<span class="token punctuation">)</span></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>如果文档宽度小于 300 像素则修改背景演示(background-color)</p>
</blockquote>
<h2 id="_46-块级元素转行内元素除了-display-inline-还有什么" tabindex="-1"><a class="header-anchor" href="#_46-块级元素转行内元素除了-display-inline-还有什么" aria-hidden="true">#</a> 46. 块级元素转行内元素除了 <em>display:inline</em> 还有什么？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>display:inline-block</em></p>
</blockquote>
<h2 id="_47-对-css-hack-技术的理解" tabindex="-1"><a class="header-anchor" href="#_47-对-css-hack-技术的理解" aria-hidden="true">#</a> 47. 对 <em>CSS hack</em> 技术的理解</h2>
<blockquote>
<p>参考答案：</p>
<p><strong>什么是 CSS hack</strong>
由于不同厂商的流览器或某浏览器的不同版本（如 IE6-IE11,Firefox/Safari/Opera/Chrome 等），对 CSS 的支持、解析不一样，导致在不同浏览器的环境中呈现出不一致的页面展现效果。这时，我们为了获得统一的页面效果，就需要针对不同的浏览器或不同版本写特定的 CSS 样式，我们把这个针对不同的浏览器/不同版本写相应的 CSS code 的过程，叫做 CSS hack!</p>
<p><strong>CSS hack 的原理</strong>
由于不同的浏览器和浏览器各版本对 CSS 的支持及解析结果不一样，以及 CSS 优先级对浏览器展现效果的影响，我们可以据此针对不同的浏览器情景来应用不同的 CSS。</p>
<p><strong>CSS hack 分类</strong>
CSS Hack 大致有 3 种表现形式，CSS 属性前缀法、选择器前缀法以及 IE 条件注释法（即 HTML 头部引用 if IE）Hack，实际项目中 CSS Hack 大部分是针对 IE 浏览器不同版本之间的表现差异而引入的。</p>
<ul>
<li>属性前缀法(即类内部 Hack)：例如 IE6 能识别下划线&quot;<em>&quot;和星号&quot; * &quot;，IE7 能识别星号&quot; * &quot;，但不能识别下划线&quot;</em>&quot;，IE6~IE10 都认识&quot;\9&quot;，但 firefox 前述三个都不能认识。</li>
<li>选择器前缀法(即选择器 Hack)：例如 IE6 能识别<em>html .class{}，IE7 能识别</em>+html .class{}或者*:first-child+html .class{}。</li>
<li>IE 条件注释法(即 HTML 条件注释 Hack)：针对所有 IE(注：IE10+已经不再支持条件注释)： <code>&lt;!--[if IE]&gt;</code>IE 浏览器显示的内容 <code>&lt;![endif]--&gt;</code>，针对 IE6 及以下版本： <code>&lt;!--[if lt IE 6]&gt;</code>只在 IE6-显示的内容 <code>&lt;![endif]--&gt;</code>。这类 Hack 不仅对 CSS 生效，对写在判断语句里面的所有代码都会生效。</li>
</ul>
<p>下面是微软官方推荐使用的 hack 方式：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>只在<span class="token constant">IE</span>下生效<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span><span class="token punctuation">[</span><span class="token keyword">if</span> <span class="token constant">IE</span><span class="token punctuation">]</span><span class="token operator">></span>  这段文字只在<span class="token constant">IE</span>浏览器显示<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token punctuation">[</span>endif<span class="token punctuation">]</span><span class="token operator">--</span><span class="token operator">></span>只在<span class="token constant">IE6</span>下生效<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span><span class="token punctuation">[</span><span class="token keyword">if</span> <span class="token constant">IE</span> <span class="token number">6</span><span class="token punctuation">]</span><span class="token operator">></span>  这段文字只在<span class="token constant">IE6</span>浏览器显示<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token punctuation">[</span>endif<span class="token punctuation">]</span><span class="token operator">--</span><span class="token operator">></span>只在<span class="token constant">IE6</span>以上版本生效<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span><span class="token punctuation">[</span><span class="token keyword">if</span> gte <span class="token constant">IE</span> <span class="token number">6</span><span class="token punctuation">]</span><span class="token operator">></span>  这段文字只在<span class="token constant">IE6</span><span class="token function">以上</span><span class="token punctuation">(</span>包括<span class="token punctuation">)</span>版本<span class="token constant">IE</span>浏览器显示<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token punctuation">[</span>endif<span class="token punctuation">]</span><span class="token operator">--</span><span class="token operator">></span>只在<span class="token constant">IE8</span>上不生效<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span><span class="token punctuation">[</span><span class="token keyword">if</span> <span class="token operator">!</span> <span class="token constant">IE</span> <span class="token number">8</span><span class="token punctuation">]</span><span class="token operator">></span>  这段文字在非<span class="token constant">IE8</span>浏览器显示<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token punctuation">[</span>endif<span class="token punctuation">]</span><span class="token operator">--</span><span class="token operator">></span>非<span class="token constant">IE</span>浏览器生效<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span><span class="token punctuation">[</span><span class="token keyword">if</span> <span class="token operator">!</span><span class="token constant">IE</span><span class="token punctuation">]</span><span class="token operator">></span>  这段文字只在非<span class="token constant">IE</span>浏览器显示<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token punctuation">[</span>endif<span class="token punctuation">]</span><span class="token operator">--</span><span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></blockquote>
<h2 id="_48-px-和-em-的区别" tabindex="-1"><a class="header-anchor" href="#_48-px-和-em-的区别" aria-hidden="true">#</a> 48. <em>px</em> 和 <em>em</em> 的区别</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_49-div-之间的间隙是怎么产生的-应该怎么消除" tabindex="-1"><a class="header-anchor" href="#_49-div-之间的间隙是怎么产生的-应该怎么消除" aria-hidden="true">#</a> 49. <em>div</em> 之间的间隙是怎么产生的，应该怎么消除？</h2>
<blockquote>
<p>参考答案：</p>
<p>原因：浏览器解析的时候，会把回车换行符解析成一定的间隙，间隙的大小跟默认的字体大小设置有关。</p>
<p>解决：其父元素加上 font-size:0 的属性，但是字体需要额外处理。</p>
</blockquote>
<h2 id="_50-position-有哪些值-各自的用法如何" tabindex="-1"><a class="header-anchor" href="#_50-position-有哪些值-各自的用法如何" aria-hidden="true">#</a> 50. <em>position</em> 有哪些值，各自的用法如何？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>position</em> 属性值有 <em>static、relative、absolute、fixed、sticky</em>。</p>
<ol>
<li>
<p><em>static</em>：该关键字指定元素使用正常的布局行为，即元素在文档常规流中当前的布局位置。</p>
</li>
<li>
<p><em>relative</em>：相对定位的元素是在文档中的正常位置偏移给定的值，但是不影响其他元素的偏移。</p>
</li>
<li>
<p><em>absolute</em>：相对定位的元素并未脱离文档流，而绝对定位的元素则脱离了文档流。在布置文档流中其它元素时，绝对定位元素不占据空间。绝对定位元素相对于最近的非 <em>static</em> 祖先元素定位。</p>
</li>
<li>
<p><em>fixed</em>：固定定位与绝对定位相似，但元素的包含块为 <em>viewport</em> 视口。该定位方式常用于创建在滚动屏幕时仍固定在相同位置的元素。</p>
</li>
<li>
<p><em>sticky</em>：粘性定位可以被认为是相对定位和固定定位的混合。元素在跨越特定阈值前为相对定位，之后为固定定位。</p>
</li>
</ol>
</blockquote>
<h2 id="_51-相对定位、绝对定位、固定定位的区别" tabindex="-1"><a class="header-anchor" href="#_51-相对定位、绝对定位、固定定位的区别" aria-hidden="true">#</a> 51. 相对定位、绝对定位、固定定位的区别</h2>
<blockquote>
<p>参考答案：</p>
<p>请参阅上一题答案。</p>
</blockquote>
<h2 id="_52-display-none-和-visibility-hidden-的区别" tabindex="-1"><a class="header-anchor" href="#_52-display-none-和-visibility-hidden-的区别" aria-hidden="true">#</a> 52. <em>display:none</em> 和 <em>visibility:hidden</em> 的区别</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_53-触发-bfc-的机制" tabindex="-1"><a class="header-anchor" href="#_53-触发-bfc-的机制" aria-hidden="true">#</a> 53. 触发 <em>BFC</em> 的机制</h2>
<blockquote>
<p>参考答案：</p>
<p>请参阅前面第 1 题。</p>
</blockquote>
<h2 id="_54-div-怎么垂直居中" tabindex="-1"><a class="header-anchor" href="#_54-div-怎么垂直居中" aria-hidden="true">#</a> 54. div 怎么垂直居中</h2>
<blockquote>
<p>参考答案：</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span><span class="token punctuation">></span></span>
 ...
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>father<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
         <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>children<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
         <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br></div></div><p><strong>利用 flex 垂直居中</strong></p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
 ...
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br></div></div><p><strong>transform+relative 实现的居中</strong></p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
     ...
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text/css<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
         ...
         <span class="token selector">.father</span><span class="token punctuation">{</span>
             ...
             <span class="token property">background-color</span><span class="token punctuation">:</span>#2AABD2<span class="token punctuation">;</span>
         <span class="token punctuation">}</span>
         <span class="token selector">.children</span>
         <span class="token punctuation">{</span>
...
<h2 id="_55-less、sass-是什么-为什么要用它" tabindex="-1"><a class="header-anchor" href="#_55-less、sass-是什么-为什么要用它" aria-hidden="true">#</a> 55. <em>less、sass</em> 是什么？为什么要用它？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_56-如何隐藏一个-dom-元素" tabindex="-1"><a class="header-anchor" href="#_56-如何隐藏一个-dom-元素" aria-hidden="true">#</a> 56. 如何隐藏一个 <em>DOM</em> 元素</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_57-你怎么处理页面兼容性问题" tabindex="-1"><a class="header-anchor" href="#_57-你怎么处理页面兼容性问题" aria-hidden="true">#</a> 57. 你怎么处理页面兼容性问题？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
<li>统一标准模式</li>
...
<h2 id="_58-css-引用的方式有哪些-link-和-import-的区别" tabindex="-1"><a class="header-anchor" href="#_58-css-引用的方式有哪些-link-和-import-的区别" aria-hidden="true">#</a> 58. <em>CSS</em> 引用的方式有哪些？<em>link</em> 和 <em>@import</em> 的区别？</h2>
<blockquote>
<p>参考答案：</p>
...
<ol>
<li>
<p><strong><em>link</em> 属于 <em>HTML</em> 标签，而 <em>@import</em> 完全是 <em>CSS</em> 提供的一种方式。</strong></p>
<p><em>link</em> 标签除了可以加载 <em>CSS</em> 外，还可以做很多其它的事情，比如定义 <em>RSS</em>，定义 <em>rel</em> 连接属性等，<em>@import</em> 就只能加载 <em>CSS</em> 了。</p>
</li>
<li>
<p><strong>加载顺序的差别。</strong></p>
...
<li>
<p><strong>兼容性的差别。</strong></p>
<p>由于 <em>@import</em> 是 <em>CSS2.1</em> 提出的所以老的浏览器不支持，<em>@import</em> 只有在 <em>IE5</em> 以上的才能识别，而 <em>link</em> 标签无此问题。</p>
</li>
<li>
<p><strong>当使用 <em>JS</em> 控制 <em>DOM</em> 去改变样式的时候，只能使用 <em>link</em> 标签，因为 <em>@import</em> 不是 <em>DOM</em> 可以控制的</strong>。</p>
<p>对于可换皮肤的网站而言，可以通过改变 <em>link</em> 便签这两个的 <em>href</em> 值来改变应用不用的外部样式表，但是对于 <em>import</em> 是无法操作的，毕竟不是标签。</p>
</li>
</ol>
</blockquote>
<h2 id="_59-css-动画如何实现" tabindex="-1"><a class="header-anchor" href="#_59-css-动画如何实现" aria-hidden="true">#</a> 59. <em>CSS</em> 动画如何实现？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_60-display-inline-block-在什么情况下会产生间隙" tabindex="-1"><a class="header-anchor" href="#_60-display-inline-block-在什么情况下会产生间隙" aria-hidden="true">#</a> 60. <em>display：inline-block</em> 在什么情况下会产生间隙？</h2>
<blockquote>
<p>参考答案：</p>
...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 将前一个标签结束符和后一个标签开始符写在同一行 --></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>parent<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>child<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>child2<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>缺点：代码的<strong>可读性变差。</strong></p>
<ol start="2">
<li>方法二：为父元素中设置 font-size: 0，在子元素上重置正确的 font-size</li>
</ol>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>parent<span class="token punctuation">"</span></span> <span class="token special-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token value css language-css"><span class="token property">font-size</span><span class="token punctuation">:</span> 0px</span><span class="token punctuation">"</span></span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>缺点：inline-block 元素必须设定字体，不然行内元素中的字体不会显示。 增加了代码量。</p>
<ol start="3">
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.parent .child + .child</span> <span class="token punctuation">{</span>
  <span class="token property">margin-left</span><span class="token punctuation">:</span> -2px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>缺点：元素之间间距的大小与上下文字体大小相关；并且同一大小的字体，元素之间的间距在不同浏览器下是不一样的。</p>
...
<h2 id="_61-position-和-display、overflow-发生重叠时会发生什么" tabindex="-1"><a class="header-anchor" href="#_61-position-和-display、overflow-发生重叠时会发生什么" aria-hidden="true">#</a> 61. <em>position</em> 和 <em>display、overflow</em> 发生重叠时会发生什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_62-什么是选择器-有哪些选择器" tabindex="-1"><a class="header-anchor" href="#_62-什么是选择器-有哪些选择器" aria-hidden="true">#</a> 62. 什么是选择器？有哪些选择器？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_63-什么是继承-css-中哪些属性可以继承-哪些不可以继承" tabindex="-1"><a class="header-anchor" href="#_63-什么是继承-css-中哪些属性可以继承-哪些不可以继承" aria-hidden="true">#</a> 63. 什么是继承？<em>CSS</em> 中哪些属性可以继承？哪些不可以继承？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_64-谈谈你对响应式的理解。" tabindex="-1"><a class="header-anchor" href="#_64-谈谈你对响应式的理解。" aria-hidden="true">#</a> 64. 谈谈你对响应式的理解。</h2>
<blockquote>
<p>参考答案：</p>
<p>响应式布局是 <em>Ethan Marcotte</em> 在 2010 年 5 月提出的一个概念。即页面的设计与开发应当根据用户行为，以及设备环境进行相应的响应与调整。能让一个网站兼容多个终端，展示出不同的结构样式，而不是为每个终端做一个特定的版本。</p>
<p>具体的实践方式可由多方面组成，包括使用 <em>flex</em> 布局、使用 <em>CSS3</em> 媒介查询 <em>media query</em> 实现。其特点在于灵活性较强，但缺点在于兼容性较差、工作量巨大、代码冗余、网页加载时间过长。</p>
</blockquote>
<h2 id="_65-css-的计算属性知道吗" tabindex="-1"><a class="header-anchor" href="#_65-css-的计算属性知道吗" aria-hidden="true">#</a> 65. <em>CSS</em> 的计算属性知道吗</h2>
<blockquote>
<p>参考答案：</p>
<p>即 <em>calc( )</em> 函数，主要用于指定元素的长度，支持所有 CSS 长度单位，运算符前后都需要保留一个空格。</p>
<p>比如： <em>width: calc(100% - 50px);</em></p>
</blockquote>
<h2 id="_66-为何-css-放在-html-头部" tabindex="-1"><a class="header-anchor" href="#_66-为何-css-放在-html-头部" aria-hidden="true">#</a> 66. 为何 <em>CSS</em> 放在 <em>HTML</em> 头部？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_67-background-size-有哪-4-种值类型" tabindex="-1"><a class="header-anchor" href="#_67-background-size-有哪-4-种值类型" aria-hidden="true">#</a> 67. <em>background-size</em> 有哪 <em>4</em> 种值类型？</h2>
<blockquote>
<p>参考答案：</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">background-size</span><span class="token punctuation">:</span> length|percentage|cover|contain<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ul>
...
<h2 id="_68-transition、transform、animate-的区别" tabindex="-1"><a class="header-anchor" href="#_68-transition、transform、animate-的区别" aria-hidden="true">#</a> 68. <em>transition、transform、animate</em> 的区别？</h2>
<blockquote>
<p>参考答案：</p>
<p>transition：过渡效果，它有 4 个属性：</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">transition</span><span class="token punctuation">:</span> property duration timing-function delay<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ul>
<li>
<p>property ：css 属性的名称</p>
</li>
<li>
<p>duration ：多长时间完成</p>
</li>
<li>
<p>timing-function：转速曲线</p>
</li>
<li>
<p>delay：开始的时候。</p>
</li>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">animation</span><span class="token punctuation">:</span> name duration timing-function delay iteration-count direction
...
<h2 id="_69-描述-css-reset-的作用和用途" tabindex="-1"><a class="header-anchor" href="#_69-描述-css-reset-的作用和用途" aria-hidden="true">#</a> 69. 描述 <em>CSS reset</em> 的作用和用途？</h2>
<blockquote>
<p>参考答案：</p>
<p>因为不同浏览器间的内核存在差异，对于标记都有自己默认的样式用来保证在没有自定样式的情况下也能被排列、渲染。但各个厂家有自己的风格样式，想要样式不被浏览器默认样式影响，就需要清除默认样式，使各浏览器表现得一致。</p>
</blockquote>
<h2 id="_70-在-css-中-关于盒子的-margin-属性叙述正确的是" tabindex="-1"><a class="header-anchor" href="#_70-在-css-中-关于盒子的-margin-属性叙述正确的是" aria-hidden="true">#</a> 70. 在 <em>CSS</em> 中，关于盒子的 <em>margin</em> 属性叙述正确的是</h2>
<p>A. 边距 margin 只能取一个值</p>
...
<h2 id="_71-以下代码中-属于相对定位的是" tabindex="-1"><a class="header-anchor" href="#_71-以下代码中-属于相对定位的是" aria-hidden="true">#</a> 71. 以下代码中，属于相对定位的是</h2>
<p>A. <code>#b{width:100px; position:relative}</code></p>
...
<h2 id="_72-以下选项中不能实现清除浮动的是" tabindex="-1"><a class="header-anchor" href="#_72-以下选项中不能实现清除浮动的是" aria-hidden="true">#</a> 72. 以下选项中不能实现清除浮动的是（ ）</h2>
<p>A. 空 div</p>
<p>B. hover 伪选择器</p>
<p>C. clear 属性</p>
<p>D. overflow 属性</p>
...
<h2 id="_73-关于-z-index-属性叙述正确的是" tabindex="-1"><a class="header-anchor" href="#_73-关于-z-index-属性叙述正确的是" aria-hidden="true">#</a> 73. 关于 <em>z-index</em> 属性叙述正确的是（ ）</h2>
<p>A. 必须与 postion 一起使用才能生效，此时 postion 取任何值都可以</p>
<p>B. 此值越大，层的顺序越往下</p>
...
<h2 id="_74-有一个高度自适应的-div-里面有-2-个-div-一个高度-100px-希望另一个填满剩下的高度-css-实现" tabindex="-1"><a class="header-anchor" href="#_74-有一个高度自适应的-div-里面有-2-个-div-一个高度-100px-希望另一个填满剩下的高度-css-实现" aria-hidden="true">#</a> 74. 有一个高度自适应的 div，里面有 2 个 div，一个高度 100px，希望另一个填满剩下的高度？（CSS 实现）</h2>
<blockquote>
<p>参考答案：</p>
<p>方法一：利用定位</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>main<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><p>方法二：利用计算属性<em>calc</em></p>
...
<h2 id="_75-display-有哪些值-说明他们的作用。" tabindex="-1"><a class="header-anchor" href="#_75-display-有哪些值-说明他们的作用。" aria-hidden="true">#</a> 75. <em>display</em> 有哪些值？说明他们的作用。</h2>
<blockquote>
<p>参考答案：</p>
<p>常用的有：</p>
<ul>
...
<h2 id="_76-position-的值-relative-和-absolute-的定位原点是" tabindex="-1"><a class="header-anchor" href="#_76-position-的值-relative-和-absolute-的定位原点是" aria-hidden="true">#</a> 76. <em>position</em> 的值 <em>relative</em> 和 <em>absolute</em> 的定位原点是？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_77-当-margin-top、padding-top-的值是百分比时-分别是如何计算的" tabindex="-1"><a class="header-anchor" href="#_77-当-margin-top、padding-top-的值是百分比时-分别是如何计算的" aria-hidden="true">#</a> 77. 当 margin-top、padding-top 的值是百分比时，分别是如何计算的？</h2>
<p>A. 相对父级元素的 height，相对自身的 height</p>
...
<h2 id="_78-伪元素-before-after-的作用" tabindex="-1"><a class="header-anchor" href="#_78-伪元素-before-after-的作用" aria-hidden="true">#</a> 78. 伪元素 <em>:before :after</em> 的作用？</h2>
<blockquote>
<p>参考答案：</p>
<p>特有的 <em>content</em> 可用于在 <em>CSS</em> 中向元素的头部或尾部添加内容，常用于制作小图标。</p>
</blockquote>
<h2 id="_79-如何使用选择器来隐藏第一个列表项目" tabindex="-1"><a class="header-anchor" href="#_79-如何使用选择器来隐藏第一个列表项目" aria-hidden="true">#</a> 79. 如何使用选择器来隐藏第一个列表项目？</h2>
<blockquote>
<p>参考答案：</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">ul > li:first-child</span> <span class="token punctuation">{</span>
  <span class="token property">display</span><span class="token punctuation">:</span> none<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div></blockquote>
<h2 id="_80-transition-和-animation-的区别以及应用场景" tabindex="-1"><a class="header-anchor" href="#_80-transition-和-animation-的区别以及应用场景" aria-hidden="true">#</a> 80. <em>transition</em> 和 <em>animation</em> 的区别以及应用场景？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>区别：
...
<h2 id="_81-在-rem-自适应页面中使用-sprite-会出现背景图不随元素放大缩小的情况-如何解决" tabindex="-1"><a class="header-anchor" href="#_81-在-rem-自适应页面中使用-sprite-会出现背景图不随元素放大缩小的情况-如何解决" aria-hidden="true">#</a> 81. 在 <em>rem</em> 自适应页面中使用 <em>sprite</em> 会出现背景图不随元素放大缩小的情况，如何解决？</h2>
<blockquote>
<p>参考答案：</p>
<p>将 <em>backgroud-size</em> 也换算为 <em>rem</em> 作为单位。</p>
</blockquote>
<h2 id="_82-normalize-是什么" tabindex="-1"><a class="header-anchor" href="#_82-normalize-是什么" aria-hidden="true">#</a> 82. <em>Normalize</em> 是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p>一个样式表的重置文件。因为不同浏览器间的内核存在差异，对于标记都有自己默认的样式用来保证在没有自定样式的情况下也能被排列、渲染。但各个厂家有自己的风格样式，想要样式不被浏览器默认样式影响，就需要清除默认样式，使各浏览器表现得一致。</p>
</blockquote>
<h2 id="_83-谈一谈-css-中的-2d-转换。" tabindex="-1"><a class="header-anchor" href="#_83-谈一谈-css-中的-2d-转换。" aria-hidden="true">#</a> 83. 谈一谈 <em>CSS</em> 中的 <em>2D</em> 转换。</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_84-谈一谈-css3-多列属性是什么-以及其使用场景" tabindex="-1"><a class="header-anchor" href="#_84-谈一谈-css3-多列属性是什么-以及其使用场景" aria-hidden="true">#</a> 84. 谈一谈 <em>CSS3</em> 多列属性是什么？以及其使用场景</h2>
<blockquote>
<p>参考答案：</p>
...
<p>更多多列布局相关属性可以参阅：<em>https://www.runoob.com/css3/css3-multiple-columns.html</em></p>
<p>应用场景：可以将文本内容设计成像报纸一样的多列布局。</p>
</blockquote>
<h2 id="_85-vw、vh-是什么" tabindex="-1"><a class="header-anchor" href="#_85-vw、vh-是什么" aria-hidden="true">#</a> 85. <em>vw、vh</em> 是什么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_86-如何通过选择器选择-3-的倍数" tabindex="-1"><a class="header-anchor" href="#_86-如何通过选择器选择-3-的倍数" aria-hidden="true">#</a> 86. 如何通过选择器选择 <em>3</em> 的倍数？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>:nth-child(3n){...}</em></p>
</blockquote>
<h2 id="_87-页面布局有几种方式" tabindex="-1"><a class="header-anchor" href="#_87-页面布局有几种方式" aria-hidden="true">#</a> 87. 页面布局有几种方式？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<h2 id="_88-什么是流式布局" tabindex="-1"><a class="header-anchor" href="#_88-什么是流式布局" aria-hidden="true">#</a> 88. 什么是流式布局？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_89-什么是静态布局" tabindex="-1"><a class="header-anchor" href="#_89-什么是静态布局" aria-hidden="true">#</a> 89. 什么是静态布局？</h2>
<blockquote>
<p>参考答案：</p>
...
<p>在 <em>PC</em> 中，居中布局，所有样式使用一个绝对宽度（定宽）适配当今主流屏幕宽度。在移动设备中，另外建立移动网站，单独设计一个布局，使用不同的域名，比如 <em>wap.</em> 或 <em>m.</em>。</p>
<p>这种布局方案对于 UI 设计师和前端开发人员来说都是最简单、没有兼容性问题的。但缺点显而易见，需要做两次开发。当前大部门门户网站、企业宣传站点都采用了这种布局方式。</p>
</blockquote>
<h2 id="_90-什么是自适应布局-什么是响应式布局" tabindex="-1"><a class="header-anchor" href="#_90-什么是自适应布局-什么是响应式布局" aria-hidden="true">#</a> 90. 什么是自适应布局？什么是响应式布局？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_91-对比各种布局方式的特点。" tabindex="-1"><a class="header-anchor" href="#_91-对比各种布局方式的特点。" aria-hidden="true">#</a> 91. 对比各种布局方式的特点。</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_92-文字超出了元素的宽度如何使用-css-处理" tabindex="-1"><a class="header-anchor" href="#_92-文字超出了元素的宽度如何使用-css-处理" aria-hidden="true">#</a> 92. 文字超出了元素的宽度如何使用 <em>CSS</em> 处理？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_93-内外边距取值-1-个、2-个、3-个、4-个参数分别表示什么意思" tabindex="-1"><a class="header-anchor" href="#_93-内外边距取值-1-个、2-个、3-个、4-个参数分别表示什么意思" aria-hidden="true">#</a> 93. 内外边距取值 <em>1</em> 个、<em>2</em> 个、<em>3</em> 个、<em>4</em> 个参数分别表示什么意思？</h2>
<blockquote>
<p>参考答案</p>
<ul>
<li>1 个值： <em>margin {10px;}</em> 表示上右下左</li>
<li>2 个值： <em>margin {10px 20px ;}</em> 表示上下 左右</li>
<li>3 个值： <em>margin {10px 20px 30px;}</em> 表示上 左右 下</li>
<li>3 个值： <em>margin {10px 20px 30px 40px ;}</em> 表示上 右 下 左</li>
</ul>
</blockquote>
<h2 id="_94-处理长宽不固定的元素居中方案" tabindex="-1"><a class="header-anchor" href="#_94-处理长宽不固定的元素居中方案" aria-hidden="true">#</a> 94. 处理长宽不固定的元素居中方案？</h2>
<blockquote>
<p>参考答案</p>
<ol>
...
<h2 id="_95-三角形如果不使用图片实现-css-如何实现" tabindex="-1"><a class="header-anchor" href="#_95-三角形如果不使用图片实现-css-如何实现" aria-hidden="true">#</a> 95. 三角形如果不使用图片实现，<em>CSS</em> 如何实现？</h2>
<blockquote>
<p>参考答案</p>
<p>设置块级元素宽高为 0，边框 3 条设置为透明色。具体可以参阅第 18 题答案</p>
</blockquote>
<h2 id="_96-你在工作中是如何使用伪类的-列举一些常用的伪类以及用途。" tabindex="-1"><a class="header-anchor" href="#_96-你在工作中是如何使用伪类的-列举一些常用的伪类以及用途。" aria-hidden="true">#</a> 96. 你在工作中是如何使用伪类的？列举一些常用的伪类以及用途。</h2>
<blockquote>
<p>参考答案</p>
<ol>
...
<li>使用 <em>:nth-child(3n)</em> 可以快速实现 “每 N 个实现 XX 效果”</li>
</ol>
</blockquote>
<h2 id="_97-列举-flex-布局在你的实际项目里的使用-它能很方便的帮你做一些什么事情" tabindex="-1"><a class="header-anchor" href="#_97-列举-flex-布局在你的实际项目里的使用-它能很方便的帮你做一些什么事情" aria-hidden="true">#</a> 97. 列举 <em>flex</em> 布局在你的实际项目里的使用，它能很方便的帮你做一些什么事情？</h2>
<blockquote>
<p>参考答案</p>
<p><em>flex</em> 是根据主轴和交叉轴的方向来对元素进行排列，在不固定宽高的情况下可以很方便的帮助我们进行布局、居中、控制对齐方式。</p>
</blockquote>
<h2 id="_98-如何将大量可变化的图片显示到页面并不影响浏览器性能" tabindex="-1"><a class="header-anchor" href="#_98-如何将大量可变化的图片显示到页面并不影响浏览器性能" aria-hidden="true">#</a> 98. 如何将大量可变化的图片显示到页面并不影响浏览器性能？</h2>
<blockquote>
<p>参考答案</p>
<p>使用图片懒加载。将页面中未出现在可视区域的图片先不做加载，等滚动到可视区域后，再加载。</p>
</blockquote>
<h2 id="_99-图片与图片之间默认存在的间距如何去除" tabindex="-1"><a class="header-anchor" href="#_99-图片与图片之间默认存在的间距如何去除" aria-hidden="true">#</a> 99. 图片与图片之间默认存在的间距如何去除？</h2>
<blockquote>
<p>参考答案</p>
<ol>
<li>将图片全部脱离文档流</li>
...
<h2 id="_100-阅读代码-计算元素在-w3c-盒模型中的宽度-和在-ie-盒模型中的宽度。" tabindex="-1"><a class="header-anchor" href="#_100-阅读代码-计算元素在-w3c-盒模型中的宽度-和在-ie-盒模型中的宽度。" aria-hidden="true">#</a> 100. 阅读代码，计算元素在 <em>W3C</em> 盒模型中的宽度，和在 <em>IE</em> 盒模型中的宽度。</h2>
...
<h2 id="_102-不使用-border-属性-使用其他属性模拟边框。" tabindex="-1"><a class="header-anchor" href="#_102-不使用-border-属性-使用其他属性模拟边框。" aria-hidden="true">#</a> 102. 不使用 border 属性，使用其他属性模拟边框。</h2>
<blockquote>
<p>参考答案</p>
<p>使用 <em>outline</em> 或 <em>box-shadow</em> 都可以模拟出边框。</p>
</blockquote>
<h2 id="_103-阅读代码-计算-ul-的高度。" tabindex="-1"><a class="header-anchor" href="#_103-阅读代码-计算-ul-的高度。" aria-hidden="true">#</a> 103. 阅读代码，计算 ul 的高度。</h2>
<div class="language-markup ext-markup line-numbers-mode"><pre v-pre class="language-markup"><code> <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>ul</span> <span class="token special-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token value css language-css"><span class="token property">overflow</span><span class="token punctuation">:</span> hidden<span class="token punctuation">;</span></span><span class="token punctuation">"</span></span></span><span class="token punctuation">></span></span>
...
<h2 id="_104-有哪些方式可以将-p-文字设置为红色" tabindex="-1"><a class="header-anchor" href="#_104-有哪些方式可以将-p-文字设置为红色" aria-hidden="true">#</a> 104. 有哪些方式可以将 <em>p</em> 文字设置为红色？</h2>
<blockquote>
<p>参考答案</p>
<ol>
<li>
...
<li>
<p><em>color: #FF0000;</em></p>
</li>
<li>
<p><em>color: rgb(255, 0, 0);</em></p>
</li>
<li>
<p><em>color: hsl(120, 100%, 50%);</em></p>
</li>
</ol>
</blockquote>
<h2 id="_105-如何使用媒体查询实现视口宽度大于-320px-小于-640px-时-div-元素宽度变成-30" tabindex="-1"><a class="header-anchor" href="#_105-如何使用媒体查询实现视口宽度大于-320px-小于-640px-时-div-元素宽度变成-30" aria-hidden="true">#</a> 105. 如何使用媒体查询实现视口宽度大于 320<em>px</em> 小于 640<em>px</em> 时 <em>div</em> 元素宽度变成 30%？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_106-什么是-html-实体" tabindex="-1"><a class="header-anchor" href="#_106-什么是-html-实体" aria-hidden="true">#</a> 106. 什么是 <em>HTML</em> 实体？</h2>
<blockquote>
<p>参考答案</p>
<p>即对当前文档的编码方式不能包含的字符提供一种转义表示。例如对于 “&gt;” 符号，它是 HTML 元素的一部分，如果要在文档中显示就需要进行转义为“&amp;gt;”。</p>
</blockquote>
<h2 id="_107-什么是全局属性-列举两个全局属性。" tabindex="-1"><a class="header-anchor" href="#_107-什么是全局属性-列举两个全局属性。" aria-hidden="true">#</a> 107. 什么是全局属性？列举两个全局属性。</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_108-什么是-haslayout-触发-haslayout-会有什么后果" tabindex="-1"><a class="header-anchor" href="#_108-什么是-haslayout-触发-haslayout-会有什么后果" aria-hidden="true">#</a> 108. 什么是 <em>hasLayout</em>? 触发 <em>hasLayout</em> 会有什么后果？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_109-在定位属性-position-中-哪个值会脱离文档流" tabindex="-1"><a class="header-anchor" href="#_109-在定位属性-position-中-哪个值会脱离文档流" aria-hidden="true">#</a> 109. 在定位属性 <em>position</em> 中，哪个值会脱离文档流?</h2>
<blockquote>
<p>参考答案</p>
<p><em>absolute、fixed</em>。</p>
</blockquote>
<h2 id="_110-假设视口的宽是-70px-高为-50px-执行下面代码后-div-元素的宽度为多少" tabindex="-1"><a class="header-anchor" href="#_110-假设视口的宽是-70px-高为-50px-执行下面代码后-div-元素的宽度为多少" aria-hidden="true">#</a> 110. 假设视口的宽是 <em>70px</em>，高为 <em>50px</em>，执行下面代码后，<em>div</em> 元素的宽度为多少？</h2>
<div class="language-markup ext-markup line-numbers-mode"><pre v-pre class="language-markup"><code> <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
...
<p>参考答案</p>
<p><em>vw</em> 和 <em>vh</em> 单位，1<em>vw</em> 等于视口宽度的 1/100，1<em>vh</em> 等于视口高度的 1/100，即 1<em>vw</em> = 0.7<em>px</em>，1<em>vh</em> = 0.5<em>px</em>，0.7*50 = 35<em>px</em>，0.5*50 = 25<em>px</em> ，即 <em>div</em> 宽度为 35<em>px</em>，高度 25<em>px</em>。</p>
</blockquote>
<h2 id="_111-伪元素-before-和-before-有什么区别" tabindex="-1"><a class="header-anchor" href="#_111-伪元素-before-和-before-有什么区别" aria-hidden="true">#</a> 111. 伪元素 <em>::before</em> 和 <em>:before</em> 有什么区别？</h2>
<blockquote>
<p>参考答案</p>
<p>作用相同，但 <em>CSS3</em> 规范中为了区分伪类和伪元素，将 <em>:before</em> 改为了 <em>::before</em>。</p>
</blockquote>
<h2 id="_112-cale-函数是什么-有什么作用" tabindex="-1"><a class="header-anchor" href="#_112-cale-函数是什么-有什么作用" aria-hidden="true">#</a> 112. <em>cale( )</em> 函数是什么？有什么作用？</h2>
<blockquote>
<p>参考答案</p>
<p>是 <em>CSS</em> 的一个函数，只有一个数学表达式参数，可处理数学运算，并且在表达式中可混用不同的单位。例如</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> <span class="token function">cale</span><span class="token punctuation">(</span>80% - 20px<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div></blockquote>
<h2 id="_113-first-child-和-first-of-type-有什么不同" tabindex="-1"><a class="header-anchor" href="#_113-first-child-和-first-of-type-有什么不同" aria-hidden="true">#</a> 113. <em>:first-child</em> 和 <em>:first-of-type</em> 有什么不同？</h2>
<blockquote>
<p>参考答案</p>
<ul>
...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span><span class="token punctuation">></span></span>第一个 sapn 元素<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token comment">/*匹配第一个 span*/</span>
...
<h2 id="_114-什么叫-web-安全色" tabindex="-1"><a class="header-anchor" href="#_114-什么叫-web-安全色" aria-hidden="true">#</a> 114. 什么叫 <em>web</em> 安全色？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_115-在-css-中-background-color-transparent-和-opacity-0-有什么区别" tabindex="-1"><a class="header-anchor" href="#_115-在-css-中-background-color-transparent-和-opacity-0-有什么区别" aria-hidden="true">#</a> 115. 在 <em>CSS</em> 中，<em>background-color: transparent</em> 和 <em>opacity: 0</em> 有什么区别？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_116-阅读代码分析-p-元素的字体大小。" tabindex="-1"><a class="header-anchor" href="#_116-阅读代码分析-p-元素的字体大小。" aria-hidden="true">#</a> 116. 阅读代码分析 <em>p</em> 元素的字体大小。</h2>
<div class="language-markup ext-markup line-numbers-mode"><pre v-pre class="language-markup"><code> <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
   <span class="token selector">section</span><span class="token punctuation">{</span><span class="token property">font-size</span><span class="token punctuation">:</span> 32px<span class="token punctuation">;</span><span class="token punctuation">}</span>
   <span class="token selector">section>div</span><span class="token punctuation">{</span><span class="token property">font-size</span><span class="token punctuation">:</span> 50%<span class="token punctuation">;</span><span class="token punctuation">}</span>
 </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>section</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
...
<h2 id="_117-font-face-有什么作用" tabindex="-1"><a class="header-anchor" href="#_117-font-face-有什么作用" aria-hidden="true">#</a> 117. <em>@font-face</em> 有什么作用？</h2>
<blockquote>
<p>参考答案</p>
<p>以前，<em>CSS</em> 只能使用操作系统中安装的字体，自从引入了 <em>@font-face</em> 允许使用在线字体，能将放置在服务器上的自定义字体嵌入到页面中，这个字体也可以是矢量图标。</p>
</blockquote>
<h2 id="_118-绝对定位和浮动有什么异同" tabindex="-1"><a class="header-anchor" href="#_118-绝对定位和浮动有什么异同" aria-hidden="true">#</a> 118. 绝对定位和浮动有什么异同？</h2>
<blockquote>
<p>参考答案</p>
<ol>
...
<h2 id="_119-字体风格-font-style-的关键字有两个-italic-和-oblique-它们有什么区别" tabindex="-1"><a class="header-anchor" href="#_119-字体风格-font-style-的关键字有两个-italic-和-oblique-它们有什么区别" aria-hidden="true">#</a> 119. 字体风格 <em>font-style</em> 的关键字有两个：<em>italic</em> 和 <em>oblique</em> 它们有什么区别？</h2>
<blockquote>
<p>参考答案</p>
<ul>
...
<h2 id="_120-文本-强制换行-的属性是什么" tabindex="-1"><a class="header-anchor" href="#_120-文本-强制换行-的属性是什么" aria-hidden="true">#</a> 120. 文本“强制换行”的属性是什么？</h2>
<blockquote>
<p>参考答案</p>
<p><em>word-break: break-all</em>;</p>
</blockquote>
<h2 id="_121-阅读代码-分析最终执行结果-div-的水平、垂直位置距离。" tabindex="-1"><a class="header-anchor" href="#_121-阅读代码-分析最终执行结果-div-的水平、垂直位置距离。" aria-hidden="true">#</a> 121. 阅读代码，分析最终执行结果 <em>div</em> 的水平、垂直位置距离。</h2>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> 200px<span class="token punctuation">;</span>
  <span class="token property">height</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
  <span class="token property">padding</span><span class="token punctuation">:</span> 10px<span class="token punctuation">;</span>
...
<p>参考答案</p>
<p>水平位移 <em>110px</em> 垂直位移 <em>60px</em>。水平方向参照的是元素的宽度，处置方向参照的是元素的高度。<em>HTM</em>L 元素默认都以标准盒模型，当元素存在内边距，计算时还要包含内边距。即 <em>220</em> 的 <em>50%</em> 和 <em>120</em> 的 <em>50%</em>。</p>
</blockquote>
<h2 id="_122-设置了元素的过渡后需要有触发条件才能看到效果-列举出可用的触发条件。" tabindex="-1"><a class="header-anchor" href="#_122-设置了元素的过渡后需要有触发条件才能看到效果-列举出可用的触发条件。" aria-hidden="true">#</a> 122. 设置了元素的过渡后需要有触发条件才能看到效果，列举出可用的触发条件。</h2>
<blockquote>
<p>参考答案</p>
<ol>
...
<h2 id="_123-怎样把背景图附着在内容上" tabindex="-1"><a class="header-anchor" href="#_123-怎样把背景图附着在内容上" aria-hidden="true">#</a> 123. 怎样把背景图附着在内容上？</h2>
<blockquote>
<p>参考答案</p>
<p><em>background-attachment: fixed;</em></p>
</blockquote>
<h2 id="_124-css-优化、提高性能的方法有哪些" tabindex="-1"><a class="header-anchor" href="#_124-css-优化、提高性能的方法有哪些" aria-hidden="true">#</a> 124. <em>CSS</em> 优化、提高性能的方法有哪些？</h2>
<blockquote>
<p>参考答案</p>
<ol>
...
<h2 id="_125-网页中应该使用奇数还是偶数的字体" tabindex="-1"><a class="header-anchor" href="#_125-网页中应该使用奇数还是偶数的字体" aria-hidden="true">#</a> 125. 网页中应该使用奇数还是偶数的字体？</h2>
<blockquote>
<p>参考答案</p>
<p>偶数。偶数字号相对更容易与 <em>web</em> 设计的其他部分构成比例关系， <em>windows</em> 自带的点阵宋体（中易宋体）从 <em>Vista</em> 开始只提供 12、14、16<em>px</em> 这 3 个大小的点阵，而奇数时是用的是小一号的点。即每个字占的空间大了 1<em>px</em> 但点阵没有变，于是略显稀疏。</p>
</blockquote>
<h2 id="_126-margin-和-padding-分别适合什么场景使用" tabindex="-1"><a class="header-anchor" href="#_126-margin-和-padding-分别适合什么场景使用" aria-hidden="true">#</a> 126. <em>margin</em> 和 <em>padding</em> 分别适合什么场景使用？</h2>
<blockquote>
<p>参考答案</p>
<ul>
...
<h2 id="_127-对于-line-height-是如何理解的" tabindex="-1"><a class="header-anchor" href="#_127-对于-line-height-是如何理解的" aria-hidden="true">#</a> 127. 对于 <em>line-height</em> 是如何理解的？</h2>
<blockquote>
<p>参考答案</p>
<ul>
...
<h2 id="_128-如何让-chrome-支持小于-12px-的文字" tabindex="-1"><a class="header-anchor" href="#_128-如何让-chrome-支持小于-12px-的文字" aria-hidden="true">#</a> 128. 如何让 <em>Chrome</em> 支持小于 12px 的文字？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_129-如果需要手动写动画-你认为最小时间间隔是多久" tabindex="-1"><a class="header-anchor" href="#_129-如果需要手动写动画-你认为最小时间间隔是多久" aria-hidden="true">#</a> 129. 如果需要手动写动画，你认为最小时间间隔是多久？</h2>
<blockquote>
<p>参考答案</p>
<p>多数显示器默认频率是 60<em>Hz</em>，即 1<em>s</em> 刷新 60 次，理论上最小间隔为 1/60*1000<em>ms</em> = 16.7<em>ms</em></p>
</blockquote>
<h2 id="_130-简述-png、jpg、gif-这些图片格式的适用场景-有没有了解过-webp" tabindex="-1"><a class="header-anchor" href="#_130-简述-png、jpg、gif-这些图片格式的适用场景-有没有了解过-webp" aria-hidden="true">#</a> 130. 简述 <em>png、jpg、gif</em> 这些图片格式的适用场景，有没有了解过 <em>webp</em>?</h2>
<blockquote>
<p>参考答案</p>
<ul>
...
<li><em>gif</em> 是一种位图文件格式，以 8 位色重现真色彩的图像。可以实现动画效果。</li>
<li><em>webp</em> 格式是谷歌在 2010 年推出的图片格式，压缩率只有 <em>jpg</em> 的 2/3，大小比 <em>png</em> 小了 45%。缺点是压缩的时间更久了，兼容性不好，目前只有 <em>Google</em> 和 opera 支持。</li>
</ul>
</blockquote>
<h2 id="_131-style-标签写在-body-后面与-body-前面有什么区别" tabindex="-1"><a class="header-anchor" href="#_131-style-标签写在-body-后面与-body-前面有什么区别" aria-hidden="true">#</a> 131. <em>style</em> 标签写在 <em>body</em> 后面与 <em>body</em> 前面有什么区别？</h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_132-阐述一下-css-sprites" tabindex="-1"><a class="header-anchor" href="#_132-阐述一下-css-sprites" aria-hidden="true">#</a> 132. 阐述一下 <em>CSS Sprites</em></h2>
<blockquote>
<p>参考答案</p>
...
<h2 id="_133-写出背景色渐变的-css-代码" tabindex="-1"><a class="header-anchor" href="#_133-写出背景色渐变的-css-代码" aria-hidden="true">#</a> 133. 写出背景色渐变的 <em>CSS</em> 代码</h2>
<blockquote>
<p>参考答案</p>
<p><strong>线性渐变</strong></p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>direction<span class="token punctuation">,</span> color-stop1<span class="token punctuation">,</span> color-stop2<span class="token punctuation">,</span> ...<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ul>
<li>
...
<p>语法：</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">background-image</span><span class="token punctuation">:</span> <span class="token function">radial-gradient</span><span class="token punctuation">(</span>
  [&lt;position> || &lt;angle>]，[&lt;shape> || &lt;size>]，&lt;stop>，&lt;stop>，&lt;stop>
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div></blockquote>
<h2 id="_134-写出添加下划线的-css-代码" tabindex="-1"><a class="header-anchor" href="#_134-写出添加下划线的-css-代码" aria-hidden="true">#</a> 134. 写出添加下划线的 <em>CSS</em> 代码</h2>
<blockquote>
<p>参考答案</p>
<p>一般有两种方法：</p>
<ul>
...
<h2 id="_135-写出让对象顺时针旋转-90-度的-css-代码-最好附带动画效果" tabindex="-1"><a class="header-anchor" href="#_135-写出让对象顺时针旋转-90-度的-css-代码-最好附带动画效果" aria-hidden="true">#</a> 135. 写出让对象顺时针旋转 90 度的 CSS 代码（最好附带动画效果）</h2>
<blockquote>
<p>参考答案</p>
<p>顺时针旋转可以使用 <em>CSS3</em> 新增的 <em>transform</em> 属性，属性值对应 <em>rotate(90deg)</em>，如果要附带动画效果，那么可以添加 <em>transition</em> 过渡。下面是一段示例代码：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
  <span class="token property">height</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
...
<h2 id="_136-css-优先级顺序正确的是" tabindex="-1"><a class="header-anchor" href="#_136-css-优先级顺序正确的是" aria-hidden="true">#</a> 136. CSS 优先级顺序正确的是（ ）</h2>
<p>A. !important &gt; class &gt; id &gt; tag</p>
...
<h2 id="_137-如何产生带有正方形项目的列表" tabindex="-1"><a class="header-anchor" href="#_137-如何产生带有正方形项目的列表" aria-hidden="true">#</a> 137. 如何产生带有正方形项目的列表</h2>
<p>A. <em>type:square</em></p>
<p>B. <em>type:2</em></p>
...
<p>具体属性值可以参阅：<em>https://www.w3school.com.cn/cssref/pr_list-style-type.asp</em></p>
</blockquote>
<h2 id="_138-手写一个三栏布局-要求-垂直三栏布局-所有两栏宽度固定-中间自适应" tabindex="-1"><a class="header-anchor" href="#_138-手写一个三栏布局-要求-垂直三栏布局-所有两栏宽度固定-中间自适应" aria-hidden="true">#</a> 138. 手写一个三栏布局，要求：垂直三栏布局，所有两栏宽度固定，中间自适应</h2>
<blockquote>
<p>参考答案：</p>
...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">&lt;style>
.layout.flexbox</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
&lt;/style>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><p>方法二：网格布局解决方案</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>
...
.layout.grid .left-center-right</span> <span class="token punctuation">{</span>
