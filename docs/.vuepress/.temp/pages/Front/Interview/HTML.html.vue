...
<p><img src="@source/Front/Interview/imgs/html.jpg" alt="html"></p>
<h2 id="_1-什么是-doctype-是否需要在-html5-中使用" tabindex="-1"><a class="header-anchor" href="#_1-什么是-doctype-是否需要在-html5-中使用" aria-hidden="true">#</a> 1. 什么是 &lt;!DOCTYPE&gt;？是否需要在 <em>HTML5</em> 中使用？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_2-什么是可替换元素-什么是非可替换元素-它们各自有什么特点" tabindex="-1"><a class="header-anchor" href="#_2-什么是可替换元素-什么是非可替换元素-它们各自有什么特点" aria-hidden="true">#</a> 2. 什么是可替换元素，什么是非可替换元素，它们各自有什么特点？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_3-src-和-href-的区别-京东" tabindex="-1"><a class="header-anchor" href="#_3-src-和-href-的区别-京东" aria-hidden="true">#</a> 3. <em>src</em> 和 <em>href</em> 的区别（京东）</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_4-说说常用的-meta-标签" tabindex="-1"><a class="header-anchor" href="#_4-说说常用的-meta-标签" aria-hidden="true">#</a> 4. 说说常用的 <em>meta</em> 标签</h2>
<blockquote>
<p>参考答案：</p>
<p><em>meta</em> 标签提供关于 HTML 文档的元数据。元数据不会显示在页面上，但是对于机器是可读的。它可用于浏览器（如何显示内容或重新加载页面），搜索引擎（关键词），或其他 <em>web</em> 服务。</p>
...
<p>具体的关于 <em>meta</em> 标签能够设置的属性，可以参阅：<em>https://www.runoob.com/w3cnote/meta.html</em></p>
</blockquote>
<h2 id="_5-说说对-html-语义化的理解" tabindex="-1"><a class="header-anchor" href="#_5-说说对-html-语义化的理解" aria-hidden="true">#</a> 5. 说说对 <em>html</em> 语义化的理解</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>div id<span class="token operator">=</span><span class="token string">"header"</span><span class="token operator">></span>
  ...
  <span class="token operator">&lt;</span>h2<span class="token operator">></span>专注Web前端技术<span class="token operator">&lt;</span><span class="token operator">/</span>h2<span class="token operator">></span>
<span class="token operator">&lt;</span><span class="token operator">/</span>div<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>总结一下，总之就是：</p>
<ul>
<li>用正确的标签做正确的事情！</li>
...
<h2 id="_6-label-的作用是什么-是怎么用的" tabindex="-1"><a class="header-anchor" href="#_6-label-的作用是什么-是怎么用的" aria-hidden="true">#</a> 6. <em>label</em> 的作用是什么？是怎么用的？</h2>
<blockquote>
<p>参考答案：</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>label<span class="token operator">></span> 标签的 <span class="token keyword">for</span> 属性应当与相关元素的 id 属性相同。
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>上面的代码中，当 <em>label</em> 和表单控件绑定后，用户不用必须点击单选框才能确定自己的选项，点击 <em>label</em> 所包裹的文字也能够自动聚焦绑定的表单控件。</p>
</blockquote>
<h2 id="_7-iframe-框架有那些优缺点" tabindex="-1"><a class="header-anchor" href="#_7-iframe-框架有那些优缺点" aria-hidden="true">#</a> 7. <em>iframe</em> 框架有那些优缺点？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_8-html-与-xhtml-二者有什么区别-你觉得应该使用哪一个并说出理由。" tabindex="-1"><a class="header-anchor" href="#_8-html-与-xhtml-二者有什么区别-你觉得应该使用哪一个并说出理由。" aria-hidden="true">#</a> 8. <em>HTML</em> 与 <em>XHTML</em> 二者有什么区别，你觉得应该使用哪一个并说出理由。</h2>
<blockquote>
<p>参考答案：</p>
...
<ol start="5">
<li>不允许使用 *target=&quot;*blank&quot;_</li>
</ol>
<p>从 <em>XHTML 1.1</em> 开始全面禁止 <em>target</em> 属性，如果想要有开新窗口的功能，就必须改写为 <em>rel=&quot;external&quot;</em>，并搭配 <em>JavaScript</em> 实现此效果。</p>
</blockquote>
<h2 id="_9-html5-的-form-如何关闭自动完成功能" tabindex="-1"><a class="header-anchor" href="#_9-html5-的-form-如何关闭自动完成功能" aria-hidden="true">#</a> 9. <em>HTML5</em> 的 <em>form</em> 如何关闭自动完成功能？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>HTML</em> 的输入框可以拥有自动完成的功能，当你往输入框输入内容的时候，浏览器会从你以前的同名输入框的历史记录中查找出类似的内容并列在输入框下面，这样就不用全部输入进去了，直接选择列表中的项目就可以了。</p>
<p>使用 <em>autocomplete=&quot;off&quot;</em> （给不想要提示的 <em>form</em> 或某个 <em>input</em> 设置为 <em>autocomplete=off</em>。）</p>
...
<h2 id="_10-title-与-h1-的区别、b-与-strong-的区别、i-与-em-的区别" tabindex="-1"><a class="header-anchor" href="#_10-title-与-h1-的区别、b-与-strong-的区别、i-与-em-的区别" aria-hidden="true">#</a> 10. <em>title</em> 与 <em>h1</em> 的区别、<em>b</em> 与 <em>strong</em> 的区别、<em>i</em> 与 <em>em</em> 的区别？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_11-请描述下-seo-中的-tdk" tabindex="-1"><a class="header-anchor" href="#_11-请描述下-seo-中的-tdk" aria-hidden="true">#</a> 11. 请描述下 <em>SEO</em> 中的 <em>TDK</em>？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_12-每个-html-文件头里都有个很重要的东西-doctype-知道这是干什么的么" tabindex="-1"><a class="header-anchor" href="#_12-每个-html-文件头里都有个很重要的东西-doctype-知道这是干什么的么" aria-hidden="true">#</a> 12. 每个 <em>HTML</em> 文件头里都有个很重要的东西，<em>Doctype</em>，知道这是干什么的么？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_13-什么是严格模式与混杂模式" tabindex="-1"><a class="header-anchor" href="#_13-什么是严格模式与混杂模式" aria-hidden="true">#</a> 13. 什么是严格模式与混杂模式？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>严格模式：以浏览器支持的最高标准运行</p>
</li>
<li>
<p>混杂模式：页面以宽松向下兼容的方式显示，模拟老式浏览器的行为</p>
</li>
</ul>
</blockquote>
<h2 id="_14-对于-web-标准以及-w3c-的理解与认识问题" tabindex="-1"><a class="header-anchor" href="#_14-对于-web-标准以及-w3c-的理解与认识问题" aria-hidden="true">#</a> 14. 对于 <em>WEB</em> 标准以及 <em>W3C</em> 的理解与认识问题</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_15-列举-ie-与其他浏览器不一样的特性" tabindex="-1"><a class="header-anchor" href="#_15-列举-ie-与其他浏览器不一样的特性" aria-hidden="true">#</a> 15. 列举 <em>IE</em> 与其他浏览器不一样的特性？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p><em>IE</em> 的排版引擎是 <em>Trident</em> （又称为 <em>MSHTML</em>）</p>
</li>
<li>
<p><em>Trident</em> 内核曾经几乎与 <em>W3C</em> 标准脱节</p>
</li>
<li>
<p><em>Trident</em> 内核的大量 <em>Bug</em> 等安全性问题没有得到及时解决</p>
</li>
<li>
<p><em>JS</em> 方面，有很多独立的方法，例如绑定事件的 <em>attachEvent</em>、创建事件的 <em>createEventObject</em> 等</p>
</li>
<li>
<p><em>CSS</em> 方面，也有自己独有的处理方式，例如设置透明，低版本 <em>IE</em> 中使用滤镜的方式，盒模型也和 <em>W3C</em> 规定的盒模型不同</p>
</li>
</ul>
</blockquote>
<h2 id="_16-前端页面有哪三层构成-分别是什么-作用是什么" tabindex="-1"><a class="header-anchor" href="#_16-前端页面有哪三层构成-分别是什么-作用是什么" aria-hidden="true">#</a> 16. 前端页面有哪三层构成，分别是什么？作用是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p>分成：结构层、表示层、行为层。</p>
<ol>
...
<h2 id="_17-页面可见性-page-visibility-api-可以有哪些用途" tabindex="-1"><a class="header-anchor" href="#_17-页面可见性-page-visibility-api-可以有哪些用途" aria-hidden="true">#</a> 17. 页面可见性（<em>Page Visibility</em>）<em>API</em> 可以有哪些用途？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_18-quirks-怪癖-模式是什么-它和-standards-标准-模式有什么区别" tabindex="-1"><a class="header-anchor" href="#_18-quirks-怪癖-模式是什么-它和-standards-标准-模式有什么区别" aria-hidden="true">#</a> 18. <em>Quirks</em>（怪癖）模式是什么？它和 <em>Standards</em>（标准）模式有什么区别</h2>
<blockquote>
<p>参考答案：</p>
...
<ul>
<li>
<p>盒模型：在 <em>W3C</em> 标准中，如果设置一个元素的宽度和高度，指的是元素内容的宽度和高度，而在 <em>Quirks</em> 模式下，<em>IE</em> 的宽度和高度还包含了 <em>padding</em> 和 <em>border</em>。</p>
</li>
<li>
<p>设置行内元素的高宽：在 <em>Standards</em> 模式下，给 &lt;span&gt; 等行内元素设置 <em>wdith</em> 和 <em>height</em> 都不会生效，而在 <em>Quirks</em> 模式下，则会生效。</p>
</li>
<li>
<p>设置百分比的高度：在 <em>Standards</em> 模式下，一个元素的高度是由其包含的内容来决定的，如果父元素没有设置百分比的高度，子元素设置一个百分比的高度是无效的</p>
</li>
<li>
<p>用 <em>margin:0 auto</em> 设置水平居中：使用 <em>margin:0 auto</em> 在 <em>Standards</em> 模式下可以使元素水平居中，但在 <em>Quirks</em> 模式下却会失效。</p>
</li>
</ul>
</blockquote>
<h2 id="_19-div-css-的布局较-table-布局有什么优点" tabindex="-1"><a class="header-anchor" href="#_19-div-css-的布局较-table-布局有什么优点" aria-hidden="true">#</a> 19. <em>div+css</em> 的布局较 <em>table</em> 布局有什么优点？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>样式的调整更加方便，内容和样式的分离，使页面和样式的调整变得更加方便。</p>
</li>
<li>
...
<li>
<p>易于优化（<em>SEO</em>）搜索引擎更友好，排名更容易靠前。</p>
</li>
<li>
<p>符合 <em>W3C</em> 标准。</p>
</li>
...
<h2 id="_20-请谈一下你对网页标准和标准制定机构重要性的理解。" tabindex="-1"><a class="header-anchor" href="#_20-请谈一下你对网页标准和标准制定机构重要性的理解。" aria-hidden="true">#</a> 20. 请谈一下你对网页标准和标准制定机构重要性的理解。</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_21-知道什么是微格式吗-谈谈理解。在前端构建中应该考虑微格式吗" tabindex="-1"><a class="header-anchor" href="#_21-知道什么是微格式吗-谈谈理解。在前端构建中应该考虑微格式吗" aria-hidden="true">#</a> 21. 知道什么是微格式吗？谈谈理解。在前端构建中应该考虑微格式吗？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_22-html-常见兼容性问题" tabindex="-1"><a class="header-anchor" href="#_22-html-常见兼容性问题" aria-hidden="true">#</a> 22. <em>html</em> 常见兼容性问题？</h2>
<blockquote>
<p>参考答案：</p>
<ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>这种情况之下 <em>IE</em> 会产生 <em>20px</em> 的距离</p>
<p>解决方案：在 <em>float</em> 的标签样式控制中加入</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">_display</span><span class="token punctuation">:</span> inline<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>将其转化为行内属性。( * 这个符号只有 *IE6_ 会识别）</p>
<ol start="4">
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.bb</span> <span class="token punctuation">{</span>
  ...
  .<span class="token property">background-color</span><span class="token punctuation">:</span> #00deff\9<span class="token punctuation">;</span> <span class="token comment">/*IE6、7、8 识别*/</span>
  +<span class="token property">background-color</span><span class="token punctuation">:</span> #a200ff<span class="token punctuation">;</span> <span class="token comment">/*IE6、7 识别*/</span>
  <span class="token property">_background-color</span><span class="token punctuation">:</span> #1e0bd1<span class="token punctuation">;</span> <span class="token comment">/*IE6 识别*/</span>
<span class="token punctuation">}</span>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">a:link</span> <span class="token punctuation">{</span>
<span class="token punctuation">}</span>
...
<h2 id="_23-html5-有哪些新特性、移除了那些元素" tabindex="-1"><a class="header-anchor" href="#_23-html5-有哪些新特性、移除了那些元素" aria-hidden="true">#</a> 23. <em>HTML5</em> 有哪些新特性、移除了那些元素？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_24-html-全局属性-global-attribute-有哪些" tabindex="-1"><a class="header-anchor" href="#_24-html-全局属性-global-attribute-有哪些" aria-hidden="true">#</a> 24. <em>HTML</em> 全局属性(<em>global attribute</em>)有哪些</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_25-html5-为什么只需要写-doctype-html" tabindex="-1"><a class="header-anchor" href="#_25-html5-为什么只需要写-doctype-html" aria-hidden="true">#</a> 25. <em>HTML5</em> 为什么只需要写 &lt;!DOCTYPE HTML&gt;？</h2>
<blockquote>
<p>参考答案：</p>
<p>为什么 <em>HTML5</em> 的顶部只需要一段</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p><em>HTML4</em> 却需要很长的一段</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>其主要原因，是因为 <em>HTML5</em> 不基于 <em>SGML</em>，所以不需要引用 <em>DTD</em>。</p>
<p>在 <em>HTML 4.01</em> 中，&lt;!DOCTYPE&gt; 声明引用 <em>DTD</em>，因为 <em>HTML 4.01</em> 基于 <em>SGML</em>。</p>
<p><em>DTD</em> 规定了标记语言的规则，这样浏览器才能正确地呈现内容。</p>
</blockquote>
<h2 id="_26-对-web-标准、可用性、可访问性的理解" tabindex="-1"><a class="header-anchor" href="#_26-对-web-标准、可用性、可访问性的理解" aria-hidden="true">#</a> 26. 对 <em>web</em> 标准、可用性、可访问性的理解</h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p>可用性（<em>Usability</em>）：产品是否容易上手，用户能否完成任务，效率如何，以及这过程中用户的主观感受可好，是从用户的角度来看产品的质量。可用性好意味着产品质量高，是企业的核心竞争力。</p>
</li>
<li>
<p>可访问性（<em>Accessibility</em>）：Web 内容对于残障用户的可阅读和可理解性</p>
</li>
<li>
<p>可维护性（<em>Maintainability</em>）：一般包含两个层次，一是当系统出现问题时，快速定位并解决问题的成本，成本低则可维护性好。二是代码是否容易被人理解，是否容易修改和增强功能。</p>
</li>
</ul>
</blockquote>
<h2 id="_27-html5-引入什么新的表单属性" tabindex="-1"><a class="header-anchor" href="#_27-html5-引入什么新的表单属性" aria-hidden="true">#</a> 27. <em>HTML5</em> 引入什么新的表单属性？</h2>
<blockquote>
<p>参考答案：</p>
...
<ul>
<li>
<p><em>autocomplete</em>：同上</p>
</li>
<li>
<p><em>autofocus</em>：规定输入字段在页面加载时是否获得焦点，加载完成后，光标马上定位在该 <em>input</em></p>
</li>
<li>
<p><em>form</em>：<em>form</em> 属性的值必须是其所属表单的 <em>id</em>。如需引用一个以上的表单，请使用空格分隔的列表。</p>
</li>
<li>
<p><em>formaction</em>：属性覆盖 <em>form</em> 元素的 <em>action</em> 属性，比如两个提交按钮的时候，一个是正常提交，一个是管理员提交。该属性适用于 <em>type=&quot;submit&quot;</em> 以及 <em>type=&quot;image&quot;</em>。语法是 <em>formaction=&quot;#&quot;</em></p>
</li>
<li>
<p><em>formenctype：formenctype</em> 属性覆盖 <em>form</em> 元素的 <em>enctype</em> 属性。该属性与 <em>type=&quot;submit&quot;</em> 和 <em>type=&quot;image&quot;</em> 配合使用。属性规定在发送到服务器之前应该如何对表单数据进行编码。</p>
</li>
<li>
<p><em>formmethod</em>：覆盖表单的 method 属性。适用于 type=“submit” 和 type=“image”</p>
</li>
<li>
<p><em>formnovalidate：formnovalidate</em> 属性覆盖 <em>form</em> 元素的 <em>novalidate</em> 属性。如果使用该属性，则提交表单时按钮不会执行验证过程。</p>
</li>
<li>
<p><em>formtarget</em>：覆盖表单的 <em>target</em> 属性。适用于 <em>type=&quot;submit&quot;</em> 和 <em>type=&quot;image&quot;</em>， 该属性规定在何处打开 <em>action URL</em>。</p>
</li>
<li>
<p><em>height</em> 和 <em>width</em>：<em>height</em> 和 <em>width</em> 属性规定用于 <em>image</em> 类型的 &lt;input&gt; 标签的图像高度和宽度。</p>
</li>
<li>
<p><em>list</em>：引用包含输入字段的预定义选项的 <em>datalist</em> 。</p>
</li>
<li>
<p><em>min</em> 和 <em>max</em>：<em>min</em> 属性与 <em>max</em> 属性配合使用，可创建合法值范围，两个要一对用。语法是选择 <em>0-10</em> 数字，例如：&lt;input type=&quot;number&quot; name=&quot;points&quot; min=&quot;0&quot; max=&quot;10&quot; /&gt;</p>
</li>
<li>
<p>multiple：如果使用该属性，则允许一个以上的值，比如上传文件的时候，设置这个属性后可以一次选择几个图片；multiple 属性适用于以下类型的 <code>&lt;input&gt;</code>标签：email 和 file。</p>
</li>
<li>
<p><em>pattern (regexp)</em>：描述了一个正则表达式用于验证 &lt;input&gt; 元素的值，<em>pattern</em> 属性适用于以下 &lt;input&gt; 类型：<em>text, search, url, telephone, email</em> 以及 <em>password</em>。</p>
</li>
<li>
<p><em>placeholder</em>：提供可描述输入字段预期值的提示信息 (<em>hint</em>)。该提示会在输入字段为空时显示，并会在字段获得焦点时消失。</p>
</li>
<li>
<p><em>required</em>：规定必需在提交之前填写输入字段。 如果使用该属性，则字段是必填（或必选）的。</p>
</li>
<li>
<p><em>step</em>：为输入域规定合法的数字间隔。 如果 <em>step=&quot;3&quot;</em>，则合法的数是 <em>-3、0、3、6</em> 等。<em>step</em> 属性可以与 <em>max</em> 和 <em>min</em> 属性创建一个区域值。</p>
</li>
</ul>
</blockquote>
<h2 id="_28-iframe-的作用" tabindex="-1"><a class="header-anchor" href="#_28-iframe-的作用" aria-hidden="true">#</a> 28. <em>iframe</em> 的作用</h2>
<blockquote>
<p>参考答案：</p>
<p>参考答案：</p>
...
<h2 id="_29-img-上-title-与-alt" tabindex="-1"><a class="header-anchor" href="#_29-img-上-title-与-alt" aria-hidden="true">#</a> 29. <em>img</em> 上 <em>title</em> 与 <em>alt</em></h2>
<blockquote>
<p>参考答案：</p>
<ul>
<li>
<p><em>alt</em>：如果无法显示图像，浏览器将显示 <em>alt</em> 指定的内容</p>
</li>
<li>
<p><em>title</em>：在鼠标移到元素上时显示 <em>title</em> 的内容</p>
</li>
</ul>
<p>两者之间的区别：</p>
...
<h2 id="_30-html5-新增哪些新特性" tabindex="-1"><a class="header-anchor" href="#_30-html5-新增哪些新特性" aria-hidden="true">#</a> 30. <em>HTML5</em> 新增哪些新特性 ？</h2>
<blockquote>
<p>参考答案：</p>
...
<h2 id="_31-行内元素和块级元素区别-有哪些-怎样转换-顶呱呱" tabindex="-1"><a class="header-anchor" href="#_31-行内元素和块级元素区别-有哪些-怎样转换-顶呱呱" aria-hidden="true">#</a> 31. 行内元素和块级元素区别，有哪些，怎样转换？（顶呱呱）</h2>
<blockquote>
<p>参考答案：</p>
<p>块级元素：</p>
<ul>
...
<li>宽度缺省是它的容器的 <em>100%</em>，除非设定一个宽度。</li>
...
<h2 id="_32-html5-与-html4-的区别-华安永康" tabindex="-1"><a class="header-anchor" href="#_32-html5-与-html4-的区别-华安永康" aria-hidden="true">#</a> 32. <em>HTML5</em> 与 <em>HTML4</em> 的区别（华安永康）</h2>
<blockquote>
<p>参考答案：</p>
<p>1、语法简化</p>
...
<h2 id="_33-如何处理-html5-新标签兼容问题" tabindex="-1"><a class="header-anchor" href="#_33-如何处理-html5-新标签兼容问题" aria-hidden="true">#</a> 33. 如何处理 <em>HTML5</em> 新标签兼容问题</h2>
<blockquote>
<p>参考答案：</p>
<p>主要有两种方式：</p>
<p>方法 1：实现标签被识别</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span><span class="token punctuation">[</span><span class="token keyword">if</span> lt <span class="token constant">IE</span> <span class="token number">9</span><span class="token punctuation">]</span><span class="token operator">></span>
	<span class="token operator">&lt;</span>script<span class="token operator">></span> src<span class="token operator">=</span><span class="token string">"http://html5shim.googlecode.com/svn/trunk/html5.js"</span><span class="token operator">&lt;</span><span class="token operator">/</span>script<span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>当然也可以直接把这个文件下载到自己的网站上，但这个文件必须在 <em>head</em> 标签中调用。</p>
</blockquote>
<h2 id="_34-h5-和-html5-区别" tabindex="-1"><a class="header-anchor" href="#_34-h5-和-html5-区别" aria-hidden="true">#</a> 34. <em>h5</em> 和 <em>html5</em> 区别</h2>
<blockquote>
<p>参考答案：</p>
<p><em>H5</em> 是一个产品名词，包含了最新的 <em>HTML5、CSS3、ES6</em> 等新的技术来制作的应用。</p>
<p><em>HTML5</em> 是一个技术名词，指代的就仅仅是第五代 <em>HTML</em>。</p>
</blockquote>
<h2 id="_35-form-表单上传文件时需要进行什么样的声明" tabindex="-1"><a class="header-anchor" href="#_35-form-表单上传文件时需要进行什么样的声明" aria-hidden="true">#</a> 35. <em>form</em> 表单上传文件时需要进行什么样的声明</h2>
<blockquote>
<p>参考答案：</p>
<p>需要添加如下的声明：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>enctype="multipart/form-data"
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></blockquote>
<h2 id="_36-哪个属性可以做到当鼠标悬停在图片上时显示出文字" tabindex="-1"><a class="header-anchor" href="#_36-哪个属性可以做到当鼠标悬停在图片上时显示出文字" aria-hidden="true">#</a> 36. 哪个属性可以做到当鼠标悬停在图片上时显示出文字</h2>
<blockquote>
<p>参考答案：</p>
<p><em>title</em> 属性。当我们为图片设置了 <em>title</em> 属性后，鼠标悬停在图片上面，就会显示出 <em>title</em> 属性所设置的值。</p>
</blockquote>
<h2 id="_37-如何在一张图片上的某一个区域做到点击事件" tabindex="-1"><a class="header-anchor" href="#_37-如何在一张图片上的某一个区域做到点击事件" aria-hidden="true">#</a> 37. 如何在一张图片上的某一个区域做到点击事件</h2>
<blockquote>
<p>参考答案：</p>
<p>可以使用图片热区技术。步骤如下：</p>
<p>1、插入图片，并设置好图像的有关参数，且在 &lt;img&gt; 标记中设置参数 <em>usemap=&quot;#Map&quot;</em>，以表示对图像地图（<em>Map</em>）的引用；
2、用 &lt;map&gt; 标记设定图像地图的作用区域，并取名为：<em>Map</em>；
3、分别用 &lt;area&gt; 标记针对相应位置划分出多个矩形作用区域，并设定好其链接参数 <em>href</em>。</p>
<p>示例代码如下：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>img</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>url/to/your/image.jpg<span class="token punctuation">"</span></span> <span class="token attr-name">alt</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token punctuation">"</span></span> <span class="token attr-name">usemap</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>#Map<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
  　　<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>map</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>Map<span class="token punctuation">"</span></span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>Map<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>area</span>
      ...
      <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>#<span class="token punctuation">"</span></span>
      <span class="token attr-name">shape</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>poly<span class="token punctuation">"</span></span>
      <span class="token attr-name">coords</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>28,22,57,20,36,39,27,61<span class="token punctuation">"</span></span>
    <span class="token punctuation">/></span></span>
...
<h2 id="_38-行内元素有哪些-块级元素有哪些-空-void-元素有哪些" tabindex="-1"><a class="header-anchor" href="#_38-行内元素有哪些-块级元素有哪些-空-void-元素有哪些" aria-hidden="true">#</a> 38. 行内元素有哪些？块级元素有哪些？空（void）元素有哪些？</h2>
<blockquote>
<p>参考答案：</p>
<ul>
...
<h2 id="_39-什么是锚点" tabindex="-1"><a class="header-anchor" href="#_39-什么是锚点" aria-hidden="true">#</a> 39. 什么是锚点？</h2>
<blockquote>
<p>参考答案：</p>
<p>锚点（<em>anchor</em>）是一种特殊连接，能定位到 <em>HTML</em> 文档中某个特定位置，通过 HTML 元素的 <em>id</em> 来设置锚点。</p>
</blockquote>
<h2 id="_40-图片与-span-元素混排图像下方会出现几像素的空隙的原因是什么" tabindex="-1"><a class="header-anchor" href="#_40-图片与-span-元素混排图像下方会出现几像素的空隙的原因是什么" aria-hidden="true">#</a> 40. 图片与 <em>span</em> 元素混排图像下方会出现几像素的空隙的原因是什么？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>img</em> 作为可替换元素，它没有自己的基线，如果与不可替换元素混合排列，其行盒底端与基线对齐。由于与基线对齐，图像下方就会出现几像素的空隙。</p>
</blockquote>
<h2 id="_41-a-元素除了用于导航外-还可以有什么作用" tabindex="-1"><a class="header-anchor" href="#_41-a-元素除了用于导航外-还可以有什么作用" aria-hidden="true">#</a> 41. <em>a</em> 元素除了用于导航外，还可以有什么作用？</h2>
<blockquote>
<p>参考答案：</p>
<p><em>href</em> 属性中的 <em>url</em> 可以是浏览器支持的任何协议，所以 <em>a</em> 可以用于手机拨号 <code>&lt;a href='tel:10086'&gt;10086&lt;/a&gt;、发送短信 \&lt;a href=&quot;sms:10086?body=test&quot;&gt;</code> 等。</p>
