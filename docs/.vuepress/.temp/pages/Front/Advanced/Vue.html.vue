...
<p><a href="https://v2.cn.vuejs.org/v2/guide/" target="_blank" rel="noopener noreferrer">官方文档<ExternalLinkIcon/></a>
<img src="@source/Front/Advanced/imgs/Vue/1.jpg" alt=""></p>
<h2 id="vue基础" tabindex="-1"><a class="header-anchor" href="#vue基础" aria-hidden="true">#</a> Vue基础</h2>
...
<h3 id="props配置项" tabindex="-1"><a class="header-anchor" href="#props配置项" aria-hidden="true">#</a> props配置项</h3>
<ol>
<li>
...
<h3 id="mixin-混入" tabindex="-1"><a class="header-anchor" href="#mixin-混入" aria-hidden="true">#</a> mixin(混入)</h3>
<ol>
<li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>第二步使用混入：</p>
...
<h3 id="scoped样式" tabindex="-1"><a class="header-anchor" href="#scoped样式" aria-hidden="true">#</a> scoped样式</h3>
<ol>
<li>作用：让样式在局部生效，防止冲突。</li>
<li>写法：<code>&lt;style scoped&gt;</code></li>
</ol>
<h3 id="总结todolist案例" tabindex="-1"><a class="header-anchor" href="#总结todolist案例" aria-hidden="true">#</a> 总结TodoList案例</h3>
<ol>
<li>
<p>组件化编码流程：</p>
...
<h3 id="webstorage" tabindex="-1"><a class="header-anchor" href="#webstorage" aria-hidden="true">#</a> webStorage</h3>
<ol>
<li>
...
<h3 id="组件的自定义事件" tabindex="-1"><a class="header-anchor" href="#组件的自定义事件" aria-hidden="true">#</a> 组件的自定义事件</h3>
<ol>
<li>
...
<li>
<p>第二种方式，在父组件中：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>Demo ref<span class="token operator">=</span><span class="token string">"demo"</span><span class="token operator">/</span><span class="token operator">></span>
...
<h3 id="全局事件总线-globaleventbus" tabindex="-1"><a class="header-anchor" href="#全局事件总线-globaleventbus" aria-hidden="true">#</a> 全局事件总线（GlobalEventBus）</h3>
<ol>
<li>
...
<h3 id="消息订阅与发布-pubsub" tabindex="-1"><a class="header-anchor" href="#消息订阅与发布-pubsub" aria-hidden="true">#</a> 消息订阅与发布（pubsub）</h3>
<ol>
<li>
<p>一种组件间通信的方式，适用于<span style="color:red">任意组件间通信</span>。</p>
</li>
...
<h3 id="vue封装的过度与动画" tabindex="-1"><a class="header-anchor" href="#vue封装的过度与动画" aria-hidden="true">#</a> Vue封装的过度与动画</h3>
<ol>
<li>
...
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>transition</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>hello<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<h3 id="_2-何时使用" tabindex="-1"><a class="header-anchor" href="#_2-何时使用" aria-hidden="true">#</a> 2.何时使用？</h3>
<p>​		多个组件需要共享数据时</p>
<h3 id="_3-搭建vuex环境" tabindex="-1"><a class="header-anchor" href="#_3-搭建vuex环境" aria-hidden="true">#</a> 3.搭建vuex环境</h3>
<ol>
<li>
...
<h3 id="_4-基本使用" tabindex="-1"><a class="header-anchor" href="#_4-基本使用" aria-hidden="true">#</a> 4.基本使用</h3>
<ol>
<li>
...
<h3 id="_5-getters的使用" tabindex="-1"><a class="header-anchor" href="#_5-getters的使用" aria-hidden="true">#</a> 5.getters的使用</h3>
<ol>
<li>
...
<h3 id="_6-四个map方法的使用" tabindex="-1"><a class="header-anchor" href="#_6-四个map方法的使用" aria-hidden="true">#</a> 6.四个map方法的使用</h3>
<ol>
<li>
...
<h3 id="_7-模块化-命名空间" tabindex="-1"><a class="header-anchor" href="#_7-模块化-命名空间" aria-hidden="true">#</a> 7.模块化+命名空间</h3>
<ol>
<li>
...
<li>
<p>编写router配置项:</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//引入VueRouter</span>
...
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-link</span> <span class="token attr-name">active-class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>active<span class="token punctuation">"</span></span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/about<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>About<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-link</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>指定展示位置</p>
...
<h3 id="_2-几个注意点" tabindex="-1"><a class="header-anchor" href="#_2-几个注意点" aria-hidden="true">#</a> 2.几个注意点</h3>
<ol>
...
<h3 id="_3-多级路由-多级路由" tabindex="-1"><a class="header-anchor" href="#_3-多级路由-多级路由" aria-hidden="true">#</a> 3.多级路由（多级路由）</h3>
<ol>
<li>
...
<li>
<p>跳转（要写完整路径）：</p>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-link</span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/home/news<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>News<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-link</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
</ol>
<h3 id="_4-路由的query参数" tabindex="-1"><a class="header-anchor" href="#_4-路由的query参数" aria-hidden="true">#</a> 4.路由的query参数</h3>
<ol>
<li>
<p>传递参数</p>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token comment">&lt;!-- 跳转并携带query参数，to的字符串写法 --></span>
...
<li>
<p>接收参数：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>$route<span class="token punctuation">.</span>query<span class="token punctuation">.</span>id
...
<h3 id="_5-命名路由" tabindex="-1"><a class="header-anchor" href="#_5-命名路由" aria-hidden="true">#</a> 5.命名路由</h3>
<ol>
<li>
<p>作用：可以简化路由的跳转。</p>
</li>
...
<li>
<p>简化跳转：</p>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token comment">&lt;!--简化前，需要写完整的路径 --></span>
...
<h3 id="_6-路由的params参数" tabindex="-1"><a class="header-anchor" href="#_6-路由的params参数" aria-hidden="true">#</a> 6.路由的params参数</h3>
<ol>
<li>
...
<li>
<p>接收参数：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>$route<span class="token punctuation">.</span>params<span class="token punctuation">.</span>id
$route<span class="token punctuation">.</span>params<span class="token punctuation">.</span>title
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div></li>
</ol>
<h3 id="_7-路由的props配置" tabindex="-1"><a class="header-anchor" href="#_7-路由的props配置" aria-hidden="true">#</a> 7.路由的props配置</h3>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h3 id="_8-router-link-的replace属性" tabindex="-1"><a class="header-anchor" href="#_8-router-link-的replace属性" aria-hidden="true">#</a> 8.<code>&lt;router-link&gt;</code>的replace属性</h3>
<ol>
...
<h3 id="_9-编程式路由导航" tabindex="-1"><a class="header-anchor" href="#_9-编程式路由导航" aria-hidden="true">#</a> 9.编程式路由导航</h3>
<ol>
<li>
...
<li>
<p>具体编码：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//$router的两个API</span>
...
<h3 id="_10-缓存路由组件" tabindex="-1"><a class="header-anchor" href="#_10-缓存路由组件" aria-hidden="true">#</a> 10.缓存路由组件</h3>
<ol>
<li>
...
<li>
<p>具体编码：</p>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>keep-alive</span> <span class="token attr-name">include</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>News<span class="token punctuation">"</span></span><span class="token punctuation">></span></span> 
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-view</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-view</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>keep-alive</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div></li>
</ol>
<h3 id="_11-两个新的生命周期钩子" tabindex="-1"><a class="header-anchor" href="#_11-两个新的生命周期钩子" aria-hidden="true">#</a> 11.两个新的生命周期钩子</h3>
<ol>
...
<h3 id="_12-路由守卫" tabindex="-1"><a class="header-anchor" href="#_12-路由守卫" aria-hidden="true">#</a> 12.路由守卫</h3>
<ol>
<li>
<p>作用：对路由进行权限控制</p>
</li>
...
<li>
<p>全局守卫:</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//全局前置守卫：初始化时执行、每次路由切换前执行</span>
...
<li>
<p>独享守卫:</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token function">beforeEnter</span><span class="token punctuation">(</span><span class="token parameter">to<span class="token punctuation">,</span>from<span class="token punctuation">,</span>next</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<li>
<p>组件内守卫：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//进入守卫：通过路由规则，进入该组件时被调用</span>
...
<h3 id="_13-路由器的两种工作模式" tabindex="-1"><a class="header-anchor" href="#_13-路由器的两种工作模式" aria-hidden="true">#</a> 13.路由器的两种工作模式</h3>
<ol>
<li>
...
<h2 id="vue-cli脚手架" tabindex="-1"><a class="header-anchor" href="#vue-cli脚手架" aria-hidden="true">#</a> vue-cli脚手架</h2>
<h3 id="脚手架文件结构" tabindex="-1"><a class="header-anchor" href="#脚手架文件结构" aria-hidden="true">#</a> 脚手架文件结构</h3>
...
<h3 id="关于不同版本的vue" tabindex="-1"><a class="header-anchor" href="#关于不同版本的vue" aria-hidden="true">#</a> 关于不同版本的Vue</h3>
<ol>
...
<h3 id="vue-config-js配置文件" tabindex="-1"><a class="header-anchor" href="#vue-config-js配置文件" aria-hidden="true">#</a> vue.config.js配置文件</h3>
<ol>
<li>使用vue inspect &gt; output.js可以查看到Vue脚手架的默认配置。</li>
<li>使用vue.config.js可以对脚手架进行个性化定制，详情见：https://cli.vuejs.org/zh</li>
</ol>
<h3 id="vue脚手架配置代理" tabindex="-1"><a class="header-anchor" href="#vue脚手架配置代理" aria-hidden="true">#</a> vue脚手架配置代理</h3>
